...
metadata:
  ...
  description: >-
    After integrating, test the payment system before going live. Use test
    credentials for different payment methods like cards, net banking, UPI, EMI,
    and wallets provided in the document.
  keywords:
    - Flutter Checkout Pro SDK Integration Testing
    - PayU Flutter SDK Integration Testing
    - Test Mobile payment integration with PayU Flutter SDK
    - PayU Flutter Checkout Pro for Mobile Integration Test
