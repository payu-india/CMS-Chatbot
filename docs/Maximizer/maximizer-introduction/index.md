...
metadata:
  title: ''
  description: >-
    Learn how PayU Maximizer optimizes your payment processing by routing
    transactions through multiple aggregators with a single integration. Set up
    custom routing rules easily via the PayU Dashboard for enhanced transaction
    management on web and mobile platforms.
  keywords:
    - Payment Gateway Routing Introduction
    - Payment Gateway Routing Intro
    - Transaction Aggregator Integration Introduction
    - Multi-Aggregator Payment Solution Introduction
    - Multi-Aggregator Payment Solution Intro
  robots: index
next:
  description: ''
  pages:
    - type: basic
      slug: activate-maximizer
      title: Activate Maximizer
    - type: basic
      slug: supported-platforms-for-maximizer
...
<Image align="center" src="https://files.readme.io/a71c398-maximizer_flow.png" />
...
* [Maximizer Dashboard](doc:maximizer-dashboard)
* [APIs to Integrate Maximizer](doc:apis-to-integrate-maximizer)
* [FAQs](doc:faqs-for-maximizer)
