...
<Image align="center" className="border" border={true} src="https://files.readme.io/2a5ea40300ba75e9c959640cfcbc65f048be975e21946c3404b8e76570db7cd7-Screenshot_2024-12-18_at_2.15.05_PM.png" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/1595dbda69b2fbd8a9667c9214788cc9ce1fec1402ba64aed757d41e6d7a8a44-Screenshot_2024-12-18_at_2.20.40_PM.png" />

3. Select the **Netbanking** tab.

The **Netbanking** tab is displayed.

<Image align="center" className="border" border={true} src="https://files.readme.io/fe0898daa77a76a7e547ca644f4683960f8073be0ce1b2ca2881b66ac08030f4-Screenshot_2024-12-18_at_2.17.40_PM.png" />
...
5. Enter the amount range in the **Transaction Amount Range** field. For more information, refer to [Include an Amount Range with a Routing Rule](doc:include-an-amt-range-with-routing-rule).
   ...
   <br />
6. Click **Next** after you have selected the banks for Net Banking routing.

The *Payment Aggregator* screen is displayed.

7. Select the  **Priority Based Routing** tab.

The **Priority Based Routing** tab is displayed.

<Image align="center" className="border" border={true} src="https://files.readme.io/f532604435fcbe7fb332fe4aa28509c40350e582c0f7872dcfe6976b46500522-maximiser_priority_based_routing.png" />

8. Drag the payment aggregators using the following button next to them.

![](https://files.readme.io/1cef4de-image.png)

<br />

9. Select the **Set Custom Baseline** check box to configure custom baseline for this rule/
...
11. Enter the name for the rule in the **Title** field.
