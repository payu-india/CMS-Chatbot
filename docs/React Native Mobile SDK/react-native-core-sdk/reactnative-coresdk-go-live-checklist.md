...
After [testing the integration](https://docs.payu.in/docs/reactnative-coresdk-test-integration) end-to-end, once you are confident that the integration is working as expected, you can switch to live mode to start accepting payments from your customers. 
