...
The closed-loop wallet balance is fetched and loaded by default.

1. If the balance is not loaded due to some error, an error message will be displayed (see the screenshot below). The customer can tap on the wallet option to reload the amount.
2. Once the balance is loaded the customer can make the payment by clicking Pay Now.
