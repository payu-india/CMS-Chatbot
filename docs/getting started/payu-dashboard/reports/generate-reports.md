...
next:
  description: ''
---
Use the **Generate Report** button to generate the desired report type.

To generate a report:

1. Navigate to **Dashboard** > **Reports**.

<Image align="center" src="https://files.readme.io/2e38946-Screenshot_2023-09-29_at_10.48.05_AM.png" />

2. Click **Generate Report**.

   The *Generate Report* pop-up page is displayed.

![Graphical user interface, applicationDescription automatically generated](https://devguide.payu.in/wordpress/wp-content/uploads/2021/07/graphical-user-interface-application-description.png)

3. Select the report type from the **Select Report Type** drop-down list.
4. Select the date range from the calendar view.

![Graphical user interface, text, application, emailDescription automatically generated](https://devguide.payu.in/wordpress/wp-content/uploads/2021/07/graphical-user-interface-text-application-email.png)
