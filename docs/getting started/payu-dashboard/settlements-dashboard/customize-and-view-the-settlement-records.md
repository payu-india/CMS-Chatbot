---
title: Customize and View the Settlement Records
excerpt: ''
deprecated: false
hidden: false
metadata:
...
next:
  description: ''
---
The dashboard will show the past seven days’ settlements on the page by default. You can select a particular date range or month or year using the calendar view option given in the dashboard.
