...
sequenceDiagram
    ...
    Note over Merchant: Device compatibility check<br/>Compatible - continue<br/>Not compatible - fallback
    ...
    Note over PayU,Apple,Bank: Tokenized card rails via Apple Pay
