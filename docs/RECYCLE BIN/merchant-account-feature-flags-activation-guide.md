...
| -------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------- | --------------------- |
| `txn_s2s_flow=1`                             | Enables seamless server-to-server (S2S) flow for card and UPI payments.                                                                                                           | Contact KAM with MID                                           | UAT + Prod (separate) |
| Legacy Decoupled flow (`txn_s2s_flow=4`)     | Enables Legacy Decoupled Flow in seamless server-to-server (S2S) flow for card.                                                                                                   | Contact KAM with MID                                           | UAT+Prod              |
| Direct Authorization flow (`txn_s2s_flow=3`) | Enables Direct Authorization flow in seamless server-to-server (S2S) flow for card.                                                                                               | Contact KAM with MID                                           | UAT+Prod              |
