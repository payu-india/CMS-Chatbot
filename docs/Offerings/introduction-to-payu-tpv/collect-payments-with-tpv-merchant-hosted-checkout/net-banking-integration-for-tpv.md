...
<Accordion title="Request parameters" icon="fa-table">
  ...
  <Accordion title="Sample request" icon="fa-code">
    ...
    curl -X POST "https://test.payu.in/_payment" \
      ...
      -d "beneficiarydetail={\"beneficiaryAccountNumber\":\"002001600674\",\"ifscCode\":\"KTKB0000046\"}" \
    ...
    public class NetBankingTPVPayment {
        public static void main(String[] args) throws IOException, InterruptedException {
            ...
            String beneficiaryDetail = "{\"beneficiaryAccountNumber\":\"002001600674\",\"ifscCode\":\"KTKB0000046\"}";
            
            Map<String, String> params = new HashMap<>();
            params.put("key", "JP***g");
            params.put("txnid", "TtEmKjWF2uGliF");
    ...
    const beneficiaryDetail = JSON.stringify({
        beneficiaryAccountNumber: '002001600674',
        ifscCode: 'KTKB0000046'
    });
    ...
    my $beneficiary_detail = encode_json({
        beneficiaryAccountNumber => '002001600674',
        ifscCode => 'KTKB0000046'
    });
