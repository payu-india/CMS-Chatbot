---
title: Integrate Payment Link TPV - New
deprecated: false
hidden: true
metadata:
  robots: index
...
To use the TPV flow for Payment Links, ensure the following configuration is enabled for your merchant account:

| Parameter Key | Parameter Value | Description |
|---------------|-----------------|-------------|
| enableTpvFlow | `"1"` | If not enabled, beneficiary details will be rejected with error code 427 |

> **Note**: Contact your PayU account manager to enable this configuration.
...
class Program
{
    static async Task Main()
    {
        ...
        var response = await client.PostAsync("https://uatoneapi.payu.in/payment-links", content);
...
public class CreatePaymentLinkTPV {
    public static void main(String[] args) throws Exception {
        ...
        conn.setRequestProperty("Authorization", "Bearer 03ddf1ee8d6daf811016c1cc9ce6a3de1771092b1eaeeb936764743888b9eb75");
        conn.setRequestProperty("mid", "8237350");
...
```json
{
    ...
    "result": {
        ...
        "totalAmount": 10.0,
        "invoiceNumber": "INV123456789012",
        "paymentLink": "https://v.payu.in/PAYUMN/flashvrkWhFD",
        "description": "Payment for services",
        "active": true,
