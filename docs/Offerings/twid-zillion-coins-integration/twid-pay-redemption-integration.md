...
<Accordion title="Request parameters" icon="fa-table">
  ...
  | splitInfo                             | `JSON` This parameter must contain the TWID split information. For more information, refer to [splitInfo JSON Object Fields Description](#splitinfo-json-object-fields-description). The sample JSON for Spend/Burn or Earn Points with payment methods: <br/>-[Cards](#card) <br/>-[UPI](#upi)                                           | Refer to to [splitInfo JSON Object Fields Description](#splitinfo-json-object-fields-description). |   |
