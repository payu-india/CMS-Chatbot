...
| bankCode | The bank code identifier for the payment method. | CC |
| cardNumber | The credit/debit card number for the transaction. | 5123456789012346 |
| cvv | The Card Verification Value (CVV) for card validation. | 345 |
| validThrough | The card expiry date in MM/YY format. | 07/25 |
| ownerName | The name of the card holder or account owner. | Payu |
| transactionAmount | The amount to be processed in the transaction. | 512 |
