...
**Field Descriptions**
    ...
    | more_info<br />`mandatory for Wealth Tech` | `JSON` Array containing the Wealth Tech object (`wtParams`). For `wtParams` field descriptions, refer to Wealth Tech object wtparams fields description table below. | Refer the above JSON |
