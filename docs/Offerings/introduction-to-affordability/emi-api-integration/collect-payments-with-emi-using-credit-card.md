  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        * _Note_*: If your customer is returning to your website to shop, you must fetch all the customer’s stored cards from PayU, collect the CVV for the card the customer will be using to make payment and then post the CVV number to PayU.
      </td>
    ...
    <tr>
      ...
      <td>
        ...
        * _Note_*: For this scenario, you must include**0**.
      </td>
