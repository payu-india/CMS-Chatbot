...
<Table align={["left","left"]}>
  ...
  <tbody>
    <tr>
      ...
      <td>
        `String` Your merchant key that is generated by PayU.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        `String` The price of the product. The value of this field must be handled at your end so that it gets dynamically changed based on the price of different products.
      </td>
    </tr>
  </tbody>
</Table>
