...
<Callout icon="👍" theme="okay">
  Automatically generate code including hashing for your eCommerce website to integrate PayU Hosted Checkout with zero coding knowledge:
...
<Cards columns={2}>
  <Card title="1. Post the Pre-Auth Transaction Request" href="https://docs.payu.in/docs/payu-hosted-integration-pre-authorize-payments#step-1-post-the-pre-auth-transaction-request">
  ...
  <Card title="2. Check the Response from PayU" href="https://docs.payu.in/docs/payu-hosted-integration-pre-authorize-payments#step-2-check-the-response-from-payu">
  ...
  <Card title="3. Capture a Pre-Authorized Payment" href="https://docs.payu.in/docs/payu-hosted-integration-pre-authorize-payments#step-3-capture-a-pre-authorized-payment">
  ...
  <Card title="4. Check Action Status" href="https://docs.payu.in/docs/payu-hosted-integration-pre-authorize-payments#step-4-check-action-status">
