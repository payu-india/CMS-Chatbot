...
* **email** (mandatory): The email address of the customer (for fraud detection). Example: [ashish@abc.com](mailto:ashish@abc.com)
* **phone** (mandatory): The phone number of the customer (for fraud detection). Example: 9876543210
* **surl** (mandatory): Success URL - the page PayU will redirect to if the transaction is successful. Example: [https://apiplayground-response.herokuapp.com/](https://apiplayground-response.herokuapp.com/)
* **furl** (mandatory): Failure URL - the page PayU will redirect to if the transaction fails. Example: [https://apiplayground-response.herokuapp.com/](https://apiplayground-response.herokuapp.com/)
