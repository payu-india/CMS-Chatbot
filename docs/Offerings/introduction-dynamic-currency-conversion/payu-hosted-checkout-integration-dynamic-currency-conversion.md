...
**Steps to integrate**
<Cards columns={3}>
  <Card title="1. Make the Transaction Request to PayU and Check the Response" href="https://docs.payu.in/docs/payu-hosted-checkout-integration-with-offers#step-1-make-the-transaction-request-to-payu-and-check-the-response">
