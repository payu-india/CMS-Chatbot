...
| email<br/>`mandatory` | `String` The email address of the customer. | test@gmail.com |
| phone<br/>`mandatory` | `String` The phone number of the customer. | 9876543210 |
| surl<br/>`mandatory` | `String` The success URL, which is the page PayU will redirect to if the transaction is successful. | https://apiplayground-response.herokuapp.com/ |
| furl<br/>`mandatory` | `String` The failure URL, which is the page PayU will redirect to if the transaction is failed. | https://apiplayground-response.herokuapp.com |
