...
metadata:
  ...
  robots: index
---
When your customer wants to opt for the Cardless <Glossary>EMI</Glossary>  option, you can use the EMI APIs to check the customer’s eligibility and get the EMI amount, interest, processing fee, or No-Cost EMI and tenure. If the customer is eligible, you can post the Cardless EMI transaction.
...
<Cards columns="2">
  <Card title="1. Check the Cardless EMI Eligibility" href="#step-1-check-the-cardless-emi-eligibility">
    Verify if the customer is eligible for cardless EMI options before proceeding with the payment


  </Card>

  <Card title="2. Initiate the Payment" href="#step-2-initiate-the-payment">
    Start the payment process using Android Checkout Pro integration
...
<Tabs>
  <Tab title="Request Parameters">
    **Mandatory Parameters**
    ...
    | :------------------------------------------------------------------------------------------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :-------------------------------- |
    | key                                                                                                      | `String` Merchant <Glossary>key</Glossary> provided by PayU during onboarding.                                                                                                                                                                  | JP\*\*\*\*g                       |
    ...
    | bankcode                                                                                                 | `String` Post this parameter to identify payment options with unique bank codes and use getEmiAmountAccordingToInterest API to check for EMI code for corresponding tenure. For the list of EMI codes, refer to EMI Codes. | HDFCCL06                          |
    | panNumber _(mandatory for ICICI, HDFC Bank, and Homecredit Cardless EMI; not mandatory for other banks)_ | `String` <Glossary>PAN</Glossary> number of the customer.                                                                                                                                                                  | ABCTY1234D                        |
    | ccnum _(mandatory only for Bajaj Finserv)_                                                               | `String` Use 13-19 digit card number for credit/debit cards and validate with <Glossary>LUHN</Glossary>  algorithm.                                                                                                                              | 5123456789012346                  |
    ...
    | hash                                                                                                     | `String` It is the hash calculated by the merchant. The hash calculation logic is: <Glossary>SHA</Glossary> -512(key\|txnid\|amount\|productinfo\|firstname\|email\|udf1\|udf2\|udf3\|udf4\|udf5\|\|\|\|\|\|Salt)                                |                                   |
