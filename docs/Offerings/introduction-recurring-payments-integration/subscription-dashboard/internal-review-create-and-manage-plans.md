...
3. Provide the following details:
   ...
   | **Billing Cycle** _(shown only when Billing Type = Recurring)_    | The frequency at which recurring debits should happen                       | Mandatory for Recurring | Options: Day, Week, Month, Year                                                                                                                   |
   | **Billing Interval** _(shown only when Billing Type = Recurring)_ | The number of billing cycles between each debit                             | Mandatory for Recurring | Positive integer (e.g., 1 for every cycle, 3 for every 3 cycles)                                                                                  |
