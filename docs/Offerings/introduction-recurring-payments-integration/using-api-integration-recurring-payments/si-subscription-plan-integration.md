---
title: SI - Subscription Plan Integration
excerpt: ''
deprecated: false
hidden: false
metadata:
  title: SI - Subscription Plan Integration
  description: >-
    Learn how to define a Standing Instruction subscription plan, capture
    customer consent, and collect recurring payments through PayU APIs.
  keywords:
    - SI Subscription Plan Integration
    - Standing Instruction Subscription Plan
    - Recurring Payments Plan Integration
    - PayU Subscription Plan APIs
    - Subscription Consent Transaction
  robots: index
next:
  description: ''
---
