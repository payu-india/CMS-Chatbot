...
<Accordion title="Step 1: Implement split at your end" icon="fa-code">
<Tabs>
...
<Accordion title="JSON request structure" icon="fa-code">
...
## Get Aggregator/Parent Transaction Info
