...
| [Split by Percentage During Transaction – PayU Hosted Checkout](ref:split-by-percentage-during-transaction-payu-hosted-checkout) | Split by percentage on PayU Hosted Checkout at transaction time. |
