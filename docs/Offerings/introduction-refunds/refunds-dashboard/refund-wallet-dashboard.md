...
<Callout icon="📘" theme="info">
  **Funds cannot be withdrawn**: Funds in the Refund Wallet are non-withdrawable and strictly for refunds. Pre‑funding withdrawals are not permitted under RBI PA‑PG guidelines (refer to RBI circular no. RBI/DPSS/2025-26/141CO.DPSS.POLC.No.S-633/02-14-008/2025-26).The transferred funds must be used only for their intended purpose or for future refunds.
</Callout>
