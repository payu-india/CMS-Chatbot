...
metadata:
  robots: index
---
Configure chargeback webhooks to automatically receive instant notifications when refunds are created or refunds status has changed. This section describes how to create and configure refund webhooks using any of the following to receive automated notifications.
