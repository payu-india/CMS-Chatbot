...
|---|---|---|
| key<br/><code>mandatory</code> | <code>String</code> The merchant key, a unique identifier provided by PayU during onboarding. | JP\*\*\*\*g |
| txnid<br/><code>mandatory</code> | <code>String</code> The transaction ID, a unique reference generated by the merchant for a specific order to track and process the transaction. | ashdfu72634 |
| amount<br/><code>mandatory</code> | <code>String</code> The payment amount for the transaction in decimal format. | 10.00 |
| productinfo<br/><code>mandatory</code> | <code>String</code> A brief description of the product or service related to the payment. | iPhone |
| firstname<br/><code>mandatory</code> | <code>String</code> The first name of the customer initiating the transaction. | Ashish |
| email<br/><code>mandatory</code> | <code>String</code> The email address of the customer. | test@gmail.com |
| phone<br/><code>mandatory</code> | <code>String</code> The phone number of the customer for transaction or support purposes. | 9988776655 |
| pg<br/><code>mandatory</code> | <code>String</code> The payment gateway type. For card payments, the value is always CC. | CC |
| bankcode<br/><code>mandatory</code> | <code>String</code> The bank code identifying the card type. In this regard, include "CC" only. | CC |
| ccnum<br/><code>mandatory</code> | <code>String</code> The card number entered by the customer, which must be a 13-19 digit valid card number. | 5123456789012346 |
| ccname<br/><code>mandatory</code> | <code>String</code> Name on the card as entered by the customer. | John Doe |
| ccvv<br/><code>mandatory</code> | <code>String</code> The CVV code for the card. Typically 3 digits for most cards, or 4 digits for AMEX cards. | 123 |
| ccexpmon<br/><code>mandatory</code> | <code>String</code> Expiry month of the card in MM format (e.g., '01' for January). | 01 |
| ccexpyr<br/><code>mandatory</code> | <code>String</code> Expiry year of the card in YYYY format, as entered by the customer. | 2024 |
| surl<br/><code>mandatory</code> | <code>String</code> The success URL, used to redirect the customer after a successful transaction. | https://yourdomain.com/success |
| furl<br/><code>mandatory</code> | <code>String</code> The failure URL, used to redirect the customer in case the transaction fails. | https://yourdomain.com/failure |
| hash<br/><code>mandatory</code> | <code>String</code> The computed hash ensuring security and verifying the transaction integrity. | eabec285da28fd0... |
| s2s_device_info<br/><code>mandatory</code> | <code>String</code> This parameter must have the customer agent's device. | Mozilla |
| s2s_client_ip<br/><code>mandatory</code> | <code>String</code> This parameter must have the source IP of the customer. | 10.11.101.11 |
| txn_s2s_flow<br/><code>mandatory</code> | <code>String</code> This parameter must be passed with the value as 4. | 4 |
| address1<br/><code>optional</code> | <code>String</code> The first line of the billing address for fraud detection and chargeback issues. | H.No-123, Street X |
| address2<br/><code>optional</code> | <code>String</code> The second line of the billing address, if available. | Apartment 456 |
| city<br/><code>optional</code> | <code>String</code> Billing address city of the customer. | Mumbai |
| state<br/><code>optional</code> | <code>String</code> Billing address state of the customer. | Maharashtra |
| country<br/><code>optional</code> | <code>String</code> Billing address country of the customer. | India |
| zipcode<br/><code>optional</code> | <code>String</code> Billing address zip code for the transaction. | 400004 |
| udf1<br/><code>optional</code> | <code>String</code> User-defined field allowing merchants to store transaction-related metadata. | Custom Data |
| udf2<br/><code>optional</code> | <code>String</code> User-defined field allowing merchants to store transaction-related metadata. | Custom Data |
| udf3<br/><code>optional</code> | <code>String</code> User-defined field allowing merchants to store transaction-related metadata. | Custom Data |
| udf4<br/><code>optional</code> | <code>String</code> User-defined field allowing merchants to store transaction-related metadata. | Custom Data |
| udf5<br/><code>optional</code> | <code>String</code> User-defined field allowing merchants to store transaction-related metadata. | Custom Data |
