...
<Accordion title="Predebit Notification" icon="fa-key">
  You should call the predebit notification API before initiating the recurring payment.

  <Accordion title="Sample request" icon="fa-key">
    	```cURL
  ...
  | command `enum` | `mandatory` The command name for this REST API call is pre_debit_SI. |
	
	<Accordion title="var1 Object parameters" icon="fa-key">
  | Parameter | Description |
  | :--------------------- | :------------------------------------------------------------------- |
