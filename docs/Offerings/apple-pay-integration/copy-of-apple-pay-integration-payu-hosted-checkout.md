...
<Accordion title="Request parameters" icon="fa-table">
  ...
  | bankcode<br />`mandatory`    | `String` - This parameter specifies the payment option. For Apple Pay integration, the value must be any of the following * CCAP * MASTAP or * VISAAP.                                                                | CCAP                                                                                                                      |
