...
| email<br/>`mandatory` | `string` Customer email address | "john@example.com" |
...
| surl<br/>`mandatory` | `string` Success URL | "https://yourapp.com/success" |
| furl<br/>`mandatory` | `string` Failure URL | "https://yourapp.com/failure" |
