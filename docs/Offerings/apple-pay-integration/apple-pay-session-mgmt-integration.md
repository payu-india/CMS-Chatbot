...
<Accordion title="Request parameters" icon="fa-table">
  ...
  | authentication\_info<br /><code>mandatory</code> | `String` – Authentication info based on the PayU-side or Merchant-decryption. For more information, refer to:<br/>* [Step 2a. Merchant-side Decryption](https://docs.payu.in/?isFramePreview=true#step-2a-merchant-side-decryption)<br/>
* [Step 2b. PayU-side Decryption](https://docs.payu.in/?isFramePreview=true#step-2b-payu-side-decryption)                                                                                                                           | iPhone Case                                 |
