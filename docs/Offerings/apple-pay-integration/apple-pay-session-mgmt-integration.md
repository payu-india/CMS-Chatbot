...
| txnid<br/>`mandatory`             | `String` – Unique transaction ID (max 25 chars). Can be generated by merchant or PayU API.                                                                                         | txn_applepay_001                            |
| amount<br/>`mandatory`            | `String` – Payment amount.                                                                                                                                                          | 100.00                                      |
| authentication_info<br/>`mandatory` | `String` – Authentication info as described in #authentication-info.                                                                                        | iPhone Case                                 |
| firstname<br/>`mandatory`         | `String` – Customer’s first name.                                                                                                                                                   | John                                        |
| email<br/>`mandatory`             | `String` – Customer’s email address.                                                                                                                                                | john@example.com                            |
