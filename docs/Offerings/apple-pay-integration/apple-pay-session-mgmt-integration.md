...
| authentication_info<br/><code>mandatory</code> | `String` – `String` – Authentication info based on the PayU-side or Merchant-decryption. For more information, refer to:<br />\* [Step 2a. Merchant-side Decryption](#step-2a-merchant-side-decryption) <br />

  * [Step 2b. PayU-side Decryption](#step-2b-payu-side-decryption)  |  |
