...
<Accordion title="Request parameters" icon="fa-table">
  ...
  | bankcode<br />`mandatory`    | `String` - This parameter specifies the payment option. For Apple Pay integration, the value must be - <br />•CCAP<br />• MASTAP or<br />• VISAAP                               | CCAP                                                                                                                          |   |   |
