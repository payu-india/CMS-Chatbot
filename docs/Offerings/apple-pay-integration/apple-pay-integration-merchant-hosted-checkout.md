...
|---|---|---|
| key<br/><code>mandatory</code> | Merchant key provided by PayU during onboarding, <code>String</code> | JP***g |
| txnid<br/><code>mandatory</code> | Unique transaction ID (max 25 chars). Can be generated by merchant or PayU API, <code>String</code> | txn_applepay_001 |
| amount<br/><code>mandatory</code> | Payment amount, <code>String</code> | 100.00 |
| authentication_info<br/><code>mandatory</code> | Authentication info as described in #authentication-info, <code>String</code> | iPhone Case |
| firstname<br/><code>mandatory</code> | Customer's first name, <code>String</code> | John |
| email<br/><code>mandatory</code> | Customer's email address, <code>String</code> | john@example.com |
| phone<br/><code>mandatory</code> | Customer's phone number, <code>String</code> | 9876543210 |
| pg<br/><code>mandatory</code> | Payment category. Must be `APPLEPAY` for Apple Pay integration, <code>String</code> | APPLEPAY |
| bankcode<br/><code>mandatory</code> | Payment option. Must be `CCAP` for Apple Pay, <code>String</code> | CCAP |
| address1<br/><code>mandatory</code> | Customer address line 1, <code>String</code> | 123 Main Street |
| city<br/><code>mandatory</code> | Customer city, <code>String</code> | New York |
| state<br/><code>mandatory</code> | Customer state, <code>String</code> | NY |
| country<br/><code>mandatory</code> | Customer country, <code>String</code> | USA |
| hash<br/><code>mandatory</code> | SHA-512 hash ensuring transaction integrity. Uses the formula: sha512(key\|txnid\|amount\|productinfo\|firstname\|email\|udf1\|udf2\|udf3\|udf4\|udf5\|salt), <code>String</code> | a1b2c3d4e5f6... |
| udf1<br/><code>optional</code> | Apple transaction identifier (max 255 chars), <code>String</code> | apple_txn_12345 |
| udf2<br/><code>optional</code> | Should contain the value `MAST:credit` (max 255 chars), <code>String</code> | MAST:credit |
</Accordion>
