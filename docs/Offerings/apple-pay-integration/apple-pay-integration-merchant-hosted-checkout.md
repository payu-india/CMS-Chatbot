...
<Accordion title="Request parameters" icon="fa-table">
  ...
  | authentication_info<br />`mandatory` | `String` - This parameter contains the authentication info as described in the (Authentication Info)[#authentication-info] below this table.                                                                                               | iPhone Case                                                                                                                   |   |   |
