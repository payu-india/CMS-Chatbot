...
metadata:
  robots: index
---
This section walks you through integrating PayU's V2 Payments API for POS merchants, enabling you to accept in-person payments with advanced device tracking and omnichannel capabilities.
