...
<Cards columns={3}>
  <Card title="1. Initiate Payment" href="#step-1-initiate-the-payment-with-payu">
    Initiate the payment to PayU with pg=NEFTRTGS and unique VAN identifier

    <br />
  </Card>

  <Card title="2. Check the Challan" href="#step-2-check-the-challan">
    Review the challan and handle the response from PayU

    <br />
  </Card>

  <Card title="3. Verify Payment" href="#step-3-verify-payment">
    Verify the payment using verify\_payment API and monitor using webhooks
  </Card>

  <br />
</Cards>

<Accordion title="Key Features" icon="fa-star">
...
<Accordion title="Benefits" icon="fa-check-circle">
...
<Accordion title="Prerequisites for Reusable VAN" icon="fa-clipboard-check">
...
<Accordion title="Response handling sample code" icon="fa-code">
  ```php
  <?php
...
<Accordion title="Optional configurations" icon="fa-cog">
...
<Accordion title="Testing" icon="fa-flask">
  ### Test Environment
...
<Accordion title="Go live" icon="fa-rocket">
