...
<Accordion title="Request Parameters" icon="fa-table">
  ...
  | country<br /> `optional but recommended<br/> for higher approval rate`                           | `varchar` The customer's billing country code. This field is required for billing and fraud prevention purposes. Use ISO 3166-1 alpha-2 country codes. Character limit: 2. | India                                                         |   |
