...
<Accordion title="Request Parameters" icon="fa-table">
  ...
  | buyer\_type\_business<br /> `optional in case of B2B transaction for cross-border payments`                                                                   | `Binary` To be sent as "1" in case the buyer is a business. In case of individual buyers, it can be skipped. Default is "0".                                               |                                                               |
