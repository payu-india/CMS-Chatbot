...
<Accordion title="Request Parameters" icon="fa-table">
  ...
  | store_card_token<br />`mandatory`                                                                                            | `String`<br />This must include the token generated by PayU for the card.                                                                                                           | `1234 4567 2456 3566`                                            |
  | storecard_token_type<br />`mandatory`                                                                                             | `String`<br />This parameter is used to specify the store card token type. For this scenario, you must include 0..                                                                                                                                                                  | `0`                                                         |
