...
<Accordion title="Request parameters" icon="fa-database">
  ...
  | address1<br />`optional but recommended for higher approval rate`                                                                                                      | `String` This parameter must contain the first line of customer address (up to 100 characters).                                                                                                                                                                                                                                                                    | PayU, Bestech Business Tower, Gurgaon                                                          |
  ...
  | city<br />`optional but recommended for higher approval rate`                                                                                                          | `String` This parameter must contain the customer city (max. 50 characters).                                                                                                                                                                                                                                                                                       | Gurgaon                                                                                        |
