...
<Accordion title="Request Parameters" icon="fa-table">
  ...
  | authentication\_info<br />`mandatory`                         | `JSON`<br />Contains the 3DS authentication information from your MPI/3DS Server. Refer to [authentication\_info JSON Structure](#authentication_info-json-structure) below. | `{"eci":"05","cavv":"..."}`                        |
