...
<Accordion title="Request Parameters" icon="fa-table">
  ...
  | authentication\_info<br />`mandatory` | `JSON`<br />Contains the 3DS authentication information from your MPI/3DS Server. See [authentication_info JSON Structure](#authentication_info-json-structure) below. | `{"eci":"05","cavv":"..."}` |
  ...
  | udf\_params<br />`optional` | `String JSON`<br />UDF7 value to capture "Import or Export Code" of the buyer. UDF8 value to capture Airway Bill Number / Consignment Number (in case of goods imports). | `{"udf7":"0100000029","udf8":"99953729071"}` |
  ...
  <Accordion title="Hash Generation" icon="fa-lock">
    ...
    **With udf_params and buyer_type_business:**
    ```
...
<Accordion title="Response Parameters" icon="fa-table">
  ...
  | result.payment_source | `String`<br />Identifies the payment source. Will be `dirAuthS2S` for Direct Authorization | `dirAuthS2S` |
  | result.bank_ref_no | `String`<br />Bank reference number for the transaction | `221130127055` |
  | result.bankcode | `String`<br />Bank code (card network) | `MAST` |
  | result.error | `String`<br />Error code. `E000` indicates no error | `E000` |
  | result.error_Message | `String`<br />Error message description | `No Error` |
  | result.unmappedstatus | `String`<br />Detailed transaction status: `captured`, `auth`, `failed` | `captured` |
  | result.card_no | `String`<br />Masked card number | `XXXXXXXXXXXX2346` |
...
| Status | unmappedstatus | Description |
| ------ | -------------- | ----------- |
| success | captured | Transaction completed successfully |
...
- [Direct Authorization Integration (Standard)](doc:integrate-with-direct-authorization-s2s) - Standard Direct Authorization without PACB
- [Plain Cards Integration PACB](doc:plain-cards-integration-one-time-pacb) - Standard S2S flow without pre-authentication
- [3DS Secure 2.0 Transaction](doc:prebuilt-checkout-page-integration#3ds-secure-20-transaction) - Information on 3DS 2.0
