...
<Accordion title="Request Parameters" icon="fa-table">
  ...
  | address1<br />`mandator`                                   | `varchar` The customer's primary billing address line. This field is required for billing and fraud prevention purposes. Character limit: 255.                                                                  | 123 Main Street                                               |
