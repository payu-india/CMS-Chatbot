...
<Accordion title="Request parameters" icon="fa-table">
  ...
  <Table align={["left","left","left"]}>
    ...
    <tbody>
      ...
      <tr>
        <td style={{ textAlign: "left" }}>
          buyer\_type\_business<br /><code>optional in case of B2B transaction<br /> for cross-border<br /> payments</code>
        </td>
      ...
      <tr>
        <td style={{ textAlign: "left" }}>
          udf\_params<br /><code>optional</code>
        </td>
      ...
      <tr>
        ...
        <td style={{ textAlign: "left" }}>
          <code>String</code> Crucial security parameter using SHA512 hash encryption. Formula incorporates key, txnid, amount, productinfo, firstname, email, udf fields, si\_details, and merchant salt.
        </td>
