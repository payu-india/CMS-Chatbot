...
<Accordion title="Request Parameters" icon="fa-table">
  ...
  | address1<br />`optional but recommended for higher approval rate`                                                                                         | <code>varchar</code> The customer's primary billing address line. This field is required for billing and fraud prevention purposes. Character limit: 255.                                                       |                                                |
  | address2<br />`optional`                                                                                         | <code>varchar</code> The customer's secondary billing address line. Character limit: 255.                                                       | 123 Main Street                                               |
