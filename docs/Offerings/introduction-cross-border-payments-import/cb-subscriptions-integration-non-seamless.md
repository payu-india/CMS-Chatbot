...
<Table align={["left","left","left"]}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style={{ textAlign: "left" }}>
        <code>String</code> This parameter must contain the buyer's PAN (Permanent Account Number). This is required if AD bank requests this detail.
        <br/><strong>For UPI mandate or UPI recurring transactions</strong>: udf1 should contain the "Buyer's PAN and date of birth in the following format (separated by two pipe characters): Buyer's PAN||Buyer's DOB"
        <br/><strong>Note</strong>: If not sent in the payment request, it will be collected on the checkout page.
      </td>

      <td style={{ textAlign: "left" }}>
        AELPR1234E<br/>
        AELPR1234E||02-02-1980 (for UPI mandate/recurring)
      </td>
    </tr>
    ...
    <tr>
      ...
      <td style={{ textAlign: "left" }}>
        <code>String</code> This parameter must contain the buyer's DOB (Date of Birth) in the DD-MM-YYYY format. This is required if AD bank requests this detail.
        <br/><strong>For UPI mandate or UPI recurring transactions</strong>: udf3 should contain the "invoice ID of the transaction (generated by the merchant) and merchant name in the following format (separated by two pipe characters): InvoiceID||MerchantName" (where, MerchantName is required for PA2PA integrations only).
        <br/><strong>Note</strong>: If not sent in the payment request, it will be collected on the checkout page.
      </td>

      <td style={{ textAlign: "left" }}>
        02-02-1980<br/>
        INV-123_1231||MerchantName (for UPI mandate/recurring)
      </td>
    </tr>
    ...
    <tr>
      ...
      <td style={{ textAlign: "left" }}>
        <code>String</code> This parameter must include the end merchant legal entity name.
        <br/><strong>For UPI mandate consent and recurring transactions</strong>: This parameter value should not be passed.
      </td>
    ...
    <tr>
      ...
      <td style={{ textAlign: "left" }}>
        <code>String</code> This parameter must contain the "invoiceId" for every merchant. This field is mandatory during or after the transaction (using the udf_update API post successful transaction).
      </td>
