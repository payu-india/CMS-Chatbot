...
metadata:
  robots: index
---
This section describes step-by-step procedure to implement <Glossary>ENACH</Glossary> (Electronic <Glossary>NACH</Glossary>) <Glossary>Consent transaction</Glossary> (<Glossary>SI</Glossary> <Glossary>Mandate</Glossary> registration) for recurring <Glossary>NB</Glossary> payments using PayU's Server-to-Server (S2S) integration with the Legacy Decoupled flow.
...
<Tabs>
  <Tab title="Request Parameters">
    ...
    | :------------------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :--------------------------------------------------------------------- |
    | <Glossary>key</Glossary>         | `String`<br />The merchant key is a unique identifier for a merchant account in PayU's database.                                                                                                                                                                                                                                                                      | JPM7Fg                                                                 |
    | <Glossary>txnid</Glossary>       | `String`<br />The transaction ID is a reference number for a specific order generated by the merchant. Must be unique.                                                                                                                                                                                                                                                | enachConsentTxn12345                                                   |
    | amount                           | `String`<br />The payment amount for the transaction. <Glossary>Auto-debit</Glossary> limit is Rs.15,000 (Rs.1,00,000 for insurance/credit card bills).                                                                                                                                                                                                               | 10.00                                                                  |
    | <Glossary>productinfo</Glossary> | `String`<br />A brief description of the product. Character Limit: 100                                                                                                                                                                                                                                                                                                | Monthly <Glossary>Subscription</Glossary>                              |
    | firstname                        | `String`<br />The first name of the customer. Character Limit: 60                                                                                                                                                                                                                                                                                                     | Ashish                                                                 |
    | lastname                         | `String`<br />The last name of the customer. Character Limit: 60                                                                                                                                                                                                                                                                                                      | Verma                                                                  |
    | email                            | `String`<br />The email address of the customer. Character Limit: 50                                                                                                                                                                                                                                                                                                  | [test@gmail.com](mailto:test@gmail.com)                                |
    | phone                            | `String`<br />The phone number of the customer.                                                                                                                                                                                                                                                                                                                       | 9876543210                                                             |
    | <Glossary>surl</Glossary>        | `String`<br />The Success URL - page PayU will redirect to if the transaction is successful.                                                                                                                                                                                                                                                                          | [https://example.com/success](https://example.com/success)             |
    | <Glossary>furl</Glossary>        | `String`<br />The Failure URL - page PayU will redirect to if the transaction fails.                                                                                                                                                                                                                                                                                  | [https://example.com/failure](https://example.com/failure)             |
    | <Glossary>pg</Glossary>          | `String`<br />Payment gateway type. Must be `NB` for Net Banking transactions.                                                                                                                                                                                                                                                                                        | NB                                                                     |
    | <Glossary>bankcode</Glossary>    | `String`<br />Bank code for the payment option. Refer to [Bank Code List](https://docs.payu.in/docs/net-banking-codes) for the list of supported banks and their codes.                                                                                                                                                                                               | Refer to [Bank Code List](https://docs.payu.in/docs/net-banking-codes) |
    | SI                               | `String`<br />Signifies successful consent taken from the user. Must be `1` for subscription setup.                                                                                                                                                                                                                                                                   | 1                                                                      |
    | si_details                       | `JSON String`<br />JSON object containing mandate details (billingAmount, billingCurrency, <Glossary>Billing Cycle</Glossary>, etc.). Refer to si_details JSON Object below.                                                                                                                                                                                          | See si_details accordion                                               |
    | beneficiarydetail                | `varchar` This object represents bank account details of the customer which involves account number, name on the account and account type and needs to be passed if the recurring transaction needs to be set up against Net Banking. It includes the fields as mentioned in the [beneficiarydetail fields description](#beneficiarydetail-fields-description) table. | Refer to next section                                                  |
    | api_version                      | `String`<br />The API version. Must be `7` for SI transactions.                                                                                                                                                                                                                                                                                                       | 7                                                                      |
    | zipcode                          | `String`<br />Billing address zip code. This field is mandatory. Character Limit: 20                                                                                                                                                                                                                                                                                  | 400004                                                                 |
    ...
    | Parameter           | Description                                                                                                                                                                                                    | Example                                            |
    | :------------------ | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :------------------------------------------------- |
    | udf1                | `String`<br />The Permanent Account Number (<Glossary>PAN</Glossary> - primary taxation ID in India) of the buyer.                                                                                             | AELPR\*\*\*\*E                                     |
    | udf3                | `String` Date of Birth (DOB) of buyer in DD-MM-YYYY                                                                                                                                                            | 02-02-1980                                         |
    | udf4                | `String` End merchant legal entity name. For <Glossary>UPI</Glossary>, this field should not be passed. Character limit: 255.                                                                                  | XYZ Pvt. Ltd.                                      |
    | address1            | `String`<br />First line of billing address. Character Limit: 100                                                                                                                                              | H.No-17, Block C                                   |
    | address2            | `String`<br />Second line of billing address. Character Limit: 100                                                                                                                                             | Tilak Nagar                                        |
    | city                | `String`<br />Customer's city.                                                                                                                                                                                 | Mumbai                                             |
    | state               | `String`<br />Customer's state.                                                                                                                                                                                | Maharashtra                                        |
    | country             | `String`<br />Customer's country. Character Limit: 50                                                                                                                                                          | India                                              |
    | free_trial          | `String`<br />Set to `1` for free trial use cases. PayU adjusts the transaction amount as INR 2.00 for Net Banking.                                                                                            | 1                                                  |
    ...
    | udf_params          | `String JSON`<br /><br />UDF7 value to capture "Import or Export Code" of the buyer<br /><br />UDF8 value to capture Airway Bill Number / Consignment Number (in case of goods imports)                        | \{"udf7":"0100000029",<br />"udf8":"99953729071"\} |
  ...
  <Tab title="Sample Request">
    ...
    **Net Banking Flow**
    ...
    <Accordion title="Sample request in various language binding" icon="fa-code">
      ...
      class ENACHConsentTransaction
      {
          static async Task Main(string[] args)
          {
              ...
              var formData = new FormUrlEncodedContent(new[]
              {
                  ...
                  new KeyValuePair<string, string>("txnid", "enachConsentTxn12345"),
                  ...
                  new KeyValuePair<string, string>("bankcode", "SBIB"),
      ...
      params.append('txnid', 'enachConsentTxn12345');
      params.append('amount', '10.00');
      params.append('productinfo', 'Monthly Subscription');
      params.append('firstname', 'Ashish');
      params.append('lastname', 'Verma');
      params.append('email', 'test@payu.in');
      params.append('phone', '9988776655');
      params.append('surl', 'https://example.com/success');
      params.append('furl', 'https://example.com/failure');
      params.append('udf1', 'AELPR1234E');
      params.append('udf2', '');
      params.append('udf3', '02-02-1980');
      params.append('udf4', 'XYZ Pvt. Ltd.');
      params.append('udf5', 'INV123456');
      params.append('buyer_type_business', '1');
      params.append('udf_params', '{"udf7":"0100000029","udf8":"99953729071"}');
      params.append('pg', 'NB');
      params.append('bankcode', 'SBIB');
      ...
      public class ENACHConsentTransaction {
...
<Accordion title="Net Banking Response" icon="fa-check">
  ...
  ```json
  {
      ...
      "result": {
          "acsTemplate": "",
...
| command   | <code>String</code> API command. Must be `si_transaction`                                    | si_transaction                    |        |         |               |
| var1      | <code>JSON Object</code> Transaction details object containing mandatory and optional fields | Refer to var1 Object Fields below |        |         |               |
| hash      | <code>String</code> SHA512 hash: \`sha512(key\\                                              | command\\                         | var1\\ | salt)\` | 9f5faabedb... |

#### var1 Object Fields

| Parameter            | Description                                                                                                                                                               | Example                                             |
| :------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | :-------------------------------------------------- |
| authpayuid           | <code>String</code> The mihpayid returned in the payment response of the Registration/Consent transaction when transaction is successfully completed.                     | 6611192557                                          |
| amount               | <code>String</code> The transaction amount which will be deducted from the customer's payment instrument.                                                                 | 10.00                                               |
| txnid                | <code>String</code> Unique Transaction ID (Order ID) generated by the merchant for this recurring transaction.                                                            | REC15113506209                                      |
| firstname            | <code>String</code> First name of the buyer/customer.                                                                                                                     | John                                                |
| lastname             | <code>String</code> Last name of the buyer/customer.                                                                                                                      | Doe                                                 |
| address1             | <code>String</code> Address line 1 of the buyer.                                                                                                                          | 123 Main Street                                     |
| address2             | <code>String</code> Address line 2 of the buyer.                                                                                                                          | Anytown                                             |
| city                 | <code>String</code> City of the buyer.                                                                                                                                    | Mumbai                                              |
| state                | <code>String</code> State of the buyer.                                                                                                                                   | Maharashtra                                         |
| country              | <code>String</code> Country of the buyer. Allowed values: `IN` or `India` only.                                                                                           | IN                                                  |
| zipcode              | <code>String</code> ZIP/PIN code of the buyer. Must be a valid 6-digit Indian PIN code.                                                                                   | 400001                                              |
| phone                | <code>String</code> The phone number of the customer.                                                                                                                     | 9999999999                                          |
| email                | <code>String</code> The email address of the customer.                                                                                                                    | [customer@example.com](mailto:customer@example.com) |
| invoiceDisplayNumber | <code>String</code> A unique display number by merchant for every subsequent invoice/recurring charge. This must be the same value passed during `pre_debit_si` API call. | 12345678910                                         |
| udf5                 | <code>String</code> Invoice ID for every merchant. This field is mandatory during or after the transaction.                                                               | INV789012                                           |
...
<Callout icon="📘" theme="info">
  **Transaction Status Values**
  ...
  | pending     | Payment initiated with bank/<Glossary>NPCI</Glossary>. Final status will be notified via webhook. |
