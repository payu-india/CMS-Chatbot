...
<Accordion title="Request Parameters" icon="fa-table">
  ...
  | zipcode<br />`mandatory`                                                                    | `String`<br />Billing address zip code. This field is mandatory. Character Limit: 20                                                                                                                                                                                                                                                                                                                                                                           | 400004                                                                 |
...
| address2 <br /> <code>optional</code>                          | <code>String</code> Address line 2 of the buyer.                                                                                                                          | Anytown                                     |
