...
<Cards columns={2}>
  ...
  <Card title="3. Recurring Payment Transaction" href="#step-5-recurring-payment-transaction">
    Execute recurring payment transactions using the registered mandate.

    <br />
  </Card>

  <Card title="4. Pre-Debit SI Notification" href="#step-6-pre-debit-si-notification">
