...
* [Merchant Hosted Checkout > Cards](https://docs.payu.in/update/docs/collect-payments-with-cards-seamless)
* [Server-to-Server > General Integration](https://docs.payu.in/update/docs/server-to-server-integration)
