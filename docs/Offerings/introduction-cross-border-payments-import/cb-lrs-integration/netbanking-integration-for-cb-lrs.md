...
<Accordion title="Request Parameters" icon="fa-table">
  ...
  | udf3<br />`mandatory for LRS`                                               | `String` The date of birth of the buyer must be collected using this field in the DD/MM/YYYY format. This is required if AD bank request this detail.                                                                                                                                                                                                                                                                                                                                                                                                                                                       | 02-02-1980                                                    |
