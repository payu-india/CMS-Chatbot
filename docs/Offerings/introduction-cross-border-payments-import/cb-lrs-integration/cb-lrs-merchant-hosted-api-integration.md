...
<Accordion title="Request Parameters" icon="fa-table">
  ...
  | `address1`<br />`optional but recommended for higher approval rate`                                                 | `String` The first line of the billing address.<br />H.No- 17, Block C, Kalyan Bldg, Khardilkar Road, Mumbai<br /><br />*Note*: This information is helpful when it comes to issues related to fraud detection and chargebacks. Hence, it is must to provide the correct information.                                                                                                                                                                                                                                                                                                  | 34 Saikripa-Estate, Tilak Nagar   |
