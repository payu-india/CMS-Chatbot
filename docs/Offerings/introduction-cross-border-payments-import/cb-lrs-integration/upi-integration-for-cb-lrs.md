...
<Accordion title="Request Parameters" icon="fa-table">
  ...
  | `lrs_service_type`<br />``<br />`mandatory`<br />`for LRS`<br />`S2S`<br />`transactions`                | `String` The LRS service type describes the nature of service & decides the tax amount based on it. For more information, refer to the [lrs\_service\_type parameter values](#lrs_service_type-parameter-values) table.                                                                                                                                                                                                                                                                                                                                                                | travel                                                                                         |
