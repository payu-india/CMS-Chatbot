...
|**LRS Parameters**|||
  ...
  | `lrs_service_type`<br />`mandatory`<br />`for LRS`<br />`S2S`<br />`transactions`                                | `String` The LRS service type describes the nature of service & decides the tax amount based on it. For more information, refer to the [lrs\_service\_type parameter values](#lrs_service_type-parameter-values) table.                                                                                                                                                                                                                                                                                                                                                                | travel                                                                                         |
  | `tcs_amount`<br />`mandatory`<br />`for LRS`<br />`S2S`<br />`transactions`                                      | `String` Amount of TCS (Tax Collected at Source) to be charged.<br /><br />**Note**: The amount needs to be captured as per guidance in the [lrs\_service\_type parameter values](#lrs_service_type-parameter-values) table.                                                                                                                                                                                                                                                                                                                                                           | 2.00                                                                                           |
