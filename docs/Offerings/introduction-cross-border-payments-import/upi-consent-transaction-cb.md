...
| udf1<br/>`optional` | `String`<br/>User-defined field 1. Character Limit: 255 | ` ` |
| udf2<br/>`optional` | `String`<br/>User-defined field 2. Character Limit: 255 | ` ` |
| udf3<br/>`optional` | `String`<br/>User-defined field 3. Character Limit: 255 | ` ` |
| udf4<br/>`optional` | `String`<br/>User-defined field 4. Character Limit: 255 | ` ` |
| udf5<br/>`optional` | `String`<br/>User-defined field 5. Character Limit: 255 | ` ` |
