...
<Accordion title="Post the consent transaction to PayU" icon="fa-circle">
...
<Accordion title="Step 2: Check the response from PayU" icon="fa-reply">
...
<Accordion title="Step 3: Verify Payment" icon="fa-reply" />
