...
metadata:
  robots: index
---
This section explains how to implement the **_payment** API to collect UPI recurring payments using Merchant Hosted Checkout integration. 

<Cards columns={2}>
  <Card title="1. Initiate the Consent Transaction" href="https://docs.payu.in/docs/upi-subscription-integration#step-1-initiate-the-consent-transaction">
    Start the UPI recurring payment workflow with required parameters including key, txnid, amount, productinfo, customer details, pg='NB', bankcode, si=1, and si_details JSON object

    <br />
  </Card>

  <Card title="2. Check Response from PayU" href="https://docs.payu.in/docs/upi-subscription-integration#step-2-check-response-from-payu">
    Handle success and failure responses from PayU, verify response hash, and capture transaction status with mihpayid and other response parameters

    <br />
  </Card>

  <Card title="3. Verify the Payment" href="https://docs.payu.in/docs/upi-subscription-integration#step-3-verify-the-payment">
    Confirm the consent transaction was processed successfully before proceeding with recurring payment setup

    <br />
  </Card>

  <Card title="4. Initiate Recurring Payment" href="https://docs.payu.in/docs/upi-subscription-integration#step-4-initiate-recurring-payment">
    Execute automated recurring payments using si_transaction command with authpayuid, invoice display number, and var1 JSON object containing customer details
