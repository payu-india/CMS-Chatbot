...
metadata:
  robots: index
---
The following flow diagram illustrates flow between customer, merchant, PayU and NPCI for UPI:
<Image align="center" border={true} src="https://files.readme.io/7c195e414649a2dc194ef6f19ebc3675cb39561f7aa8844df04e876ba97011e1-merchant_hosted_upi_subscription_flow.png" className="border" />

<br />

This section explains how to implement the **_payment** API for by Wealth Tech merchants to collect UPI recurring payments using Merchant Hosted Checkout integration. 
