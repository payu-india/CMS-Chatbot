...
<Cards columns={3}>
  <Card title="1. Post the Consent Transaction" href="https://docs.payu.in/docs/pay-and-subscribe#step-1-post-the-consent-transaction">
    Send a request to PayU's payment API with SI=4 parameter for Pay and Subscribe, including mandatory parameters like transaction details, payment amount, customer details, and si\_details JSON object

    <br />
  </Card>

  <Card title="2. Check the Response from PayU" href="https://docs.payu.in/docs/pay-and-subscribe#step-2-check-the-response-from-payu">
    Parse and examine the response from PayU containing transaction status, txnid, payment mode, amount, errors, and metadata such as card tokens

    <br />
  </Card>

  <Card title="3. Verify the Payment" href="https://docs.payu.in/docs/pay-and-subscribe#step-3-verify-the-payment">
    Ensure the correctness and success of the payment status to complete the Pay and Subscribe consent transaction setup
...
<Accordion title="Request Parameters" icon="fa-table">
  ...
  Here's the updated table with the SI parameter set to 4 and the note about Pay and Subscribe applicability:
    ...
    <Table align={["left","left","left"]}>
      ...
      <tbody>
        ...
        <tr>
          ...
          <td style={{ textAlign: "left" }}>
            This parameter signifies a successful consent taken from the user by the merchant. This parameter must contain 4 for Pay and Subscribe use cases. Without this parameter sent as 4, subscription cannot be set up.
...
<Accordion title="Sample Response" icon="fa-json">
