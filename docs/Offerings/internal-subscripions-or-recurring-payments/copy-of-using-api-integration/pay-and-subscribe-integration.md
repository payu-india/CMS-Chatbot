...
<Cards columns={3}>
  <Card title="1. Post the Consent Transaction" href="https://docs.payu.in/docs/pay-and-subscribe#step-1-post-the-consent-transaction">
    Send a request to PayU's payment API with SI=4 parameter for Pay and Subscribe, including mandatory parameters like transaction details, payment amount, customer details, and si_details JSON object
