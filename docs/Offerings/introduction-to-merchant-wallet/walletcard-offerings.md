...
next:
  description: ''
---
## Closed-Loop offerings

The following are offerings for wallet/card:

### Wallet Management

* White Label Wallet Offering
* Reloadable using Credit / Debit Cards / Net Banking etc.
...
* Load and Pay using other Payment methods in case of insufficient balance
* QR Based Redemption
* Set Recurring payments for customers using wallet
...
## Semi-closed loop or Open loop offerings
