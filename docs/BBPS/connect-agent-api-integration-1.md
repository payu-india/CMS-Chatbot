...
<Card title="1. Generate Access Token" href="https://docs.payu.in/docs/connect-agent-integration#step-1-generate-access-token">
Authenticate and obtain OAuth token for API access
<br />
</Card>

<Card title="2. Fetch Biller Information" href="https://docs.payu.in/docs/connect-agent-integration#step-2-fetch-biller-information">
Get biller categories and biller details from MDM
<br />
</Card>

<Card title="3. Fetch Bill Details" href="https://docs.payu.in/docs/connect-agent-integration#step-3-fetch-bill-details">
Retrieve customer bill information from the biller
<br />
</Card>

<Card title="4. Validate Payment" href="https://docs.payu.in/docs/connect-agent-integration#step-4-validate-payment-optional">
Validate payment details before processing (if required)
<br />
</Card>

<Card title="5. Process Payment" href="https://docs.payu.in/docs/connect-agent-integration#step-5-process-payment">
...
|:--|:--|:--|
| client_id<br/>`mandatory` | `String` - Unique client ID shared by PayU | client_123 |
| client_secret<br/>`mandatory` | `String` - Secret key shared by PayU | secret_xyz |
| grant_type<br/>`mandatory` | `String` - Grant type (use client_credentials) | client_credentials |
| scope<br/>`mandatory` | `String` - Space-separated scopes for API access | read_bills create_transactions |
...
| deviceDetails<br/>`mandatory` | `Object` - Device information | \{"INITIATING_CHANNEL": "INT", "IP": "192.168.1.1"} |
...
| deviceDetails<br/>`mandatory` | `Object` - Device information | \{"INITIATING_CHANNEL": "INT", "IP": "..."} |
