...
<Accordion title="View Payment Link Details" icon="far fa-rectangle-list">
  ...
  <Accordion title="Link Details" icon="fad fa-link">
    The link and customer details are displayed in two sub-sections.

    <Tabs>
      <Tab title="Link Details">
        - **Name:&#x20;**&#x4E;ame of the Payment Link you entered during creation.
  ...
  <Accordion title="Details and Transactions" icon="far fa-money-bills">
    ...
    <Tabs>
      <Tab title="Details">
        The **Details&#x20;**&#x74;ab displays the following link information:
        ...
        - **Creator Email**
        - **Expiry Date:&#x20;**&#x54;he link expiry date and time beyond which the link will be deactivated.
        - **Partial Payment**
  ...
  2. Click the **Filter** drop-down and select one or more status and payment type checkboxes. These are the available options:
     - **Status**
       ...
       - **Expired**
         <Callout icon="📘" theme="info">
       ### **Payment Link Status**
       Not sure what **Active**, **Paid**, **Expired**, or **Deactivated** mean? See [Payment Link Statuses](doc:send-a-payment-link). </Callout>
     - **Payment Type**
       - **Standard**
       - **Partial Payment**
...
<Accordion title="Filter by Date Range" icon="far fa-calendar">
  ...
  2. Click the calendar icon and select any of the following.
     ...
     2. For a custom range, click **Custom Range**, pick a start and end date from the calendar, then click **Apply**.
        <Callout icon="fad fa-star-exclamation" theme="warning">
          ### **Watch Out!**
...
<Accordion title="Search a Payment Link" icon="fad fa-magnifying-glass">
  You can search a payment link by purpose or invoice number.
