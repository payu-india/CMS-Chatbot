...
| PhonePe   | Use the Phonepe Pre-Prod app for testing purposes as described in the following PhonePe doc. location: &lt;https://developer.phonepe.com/v1/docs/setting-up-test-account&gt;  \nDownload the app and register your mobile number and follow the instructions as described in the above PhonePe docs. | NA     |
