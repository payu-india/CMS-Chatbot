---
title: Supported Currencies for DCC
excerpt: ''
deprecated: false
hidden: false
metadata:
  title: Supported Currencies for International Payments
  description: >-
    Learn about the currencies that PayU supports for international payments and
    how to enable them for your hosted checkout page. Find out the currency
    codes, symbols, and conversion rates for over 130 currencies across the
    world.
  keywords:
    - Supported Currencies for International Payments
    - PayU India DCC Supported Currencies
    - Supported Currencies for Dynamic Currency Conversion
    - Currencies Supported for Foreign Currency Payments
  robots: index
next:
  description: ''
---
PayU India supports 130+ currencies for International payments which is highest in the industry. We help customers to pay in the currency which they understand.

The following currencies are supported for DCC or international payments by PayU:

| **Country**                                  | **ISO Code** | **Currency**                  |
| -------------------------------------------- | ------------ | ----------------------------- |
| UNITED ARAB EMIRATES (THE)                   | AED          | UAE Dirham                    |
...
| BRUNEI DARUSSALAM                            | BND          | Brunei Dollar                 |
| BOLIVIA (PLURINATIONAL STATE OF)             | BOB          | Boliviano                     |
| BRAZIL                                       | BRL          | Brazilian Real                |
| BAHAMAS (THE)                                | BSD          | Bahamian Dollar               |
| BOTSWANA                                     | BWP          | Pula                          |
| BELARUS                                      | BYN          | Belarussian Ruble             |
| BELIZE                                       | BZD          | Belize Dollar                 |
| CANADA                                       | CAD          | Canadian Dollar               |
| CONGO (THE DEMOCRATIC REPUBLIC OF THE)       | CDF          | Congolese Franc               |
...
| CABO VERDE                                   | CVE          | Cabo Verde Escudo             |
| CZECH REPUBLIC (THE)                         | CZK          | Czech Koruna                  |
| DJIBOUTI                                     | DJF          | Djibouti Franc                |
| DENMARK                                      | DKK          | Danish Krone                  |
| DOMINICAN REPUBLIC (THE)                     | DOP          | Dominican Peso                |
| ALGERIA                                      | DZD          | Algerian Dinar                |
| EGYPT                                        | EGP          | Egyptian Pound                |
| ETHIOPIA                                     | ETB          | Ethiopian Birr                |
| ANDORRA                                      | EUR          | Euro                          |
| FIJI                                         | FJD          | Fiji Dollar                   |
| FALKLAND ISLANDS (THE) \[MALVINAS\]          | FKP          | Falkland Islands Pound        |
| GUERNSEY                                     | GBP          | Pound Sterling                |
| GEORGIA                                      | GEL          | Lari                          |
| GHANA                                        | GHS          | Ghana Cedi                    |
| GIBRALTAR                                    | GIP          | Gibraltar Pound               |
| GAMBIA (THE)                                 | GMD          | Dalasi                        |
| GUINEA                                       | GNF          | Guinea Franc                  |
...
| KYRGYZSTAN                                   | KGS          | Som                           |
| CAMBODIA                                     | KHR          | Riel                          |
| COMOROS (THE)                                | KMF          | Comoro Franc                  |
| KOREA (THE REPUBLIC OF)                      | KRW          | Won                           |
| KUWAIT                                       | KWD          | Kuwaiti Dinar                 |
| CAYMAN ISLANDS (THE)                         | KYD          | Cayman Islands Dollar         |
| KAZAKHSTAN                                   | KZT          | Tenge                         |
| LAO PEOPLE’S DEMOCRATIC REPUBLIC (THE)       | LAK          | Kip                           |
| LEBANON                                      | LBP          | Lebanese Pound                |
| LIBERIA                                      | LRD          | Liberian Dollar               |
| LESOTHO                                      | LSL          | Loti                          |
| MOROCCO                                      | MAD          | Moroccan Dirham               |
| MOLDOVA (THE REPUBLIC OF)                    | MDL          | Moldovan Leu                  |
| MADAGASCAR                                   | MGA          | Malagasy Ariary               |
| REPUBLIC OF NORTH MACEDONIA                  | MKD          | Denar                         |
| MONGOLIA                                     | MNT          | Tugrik                        |
| MACAO                                        | MOP          | Pataca                        |
...
| BOUVET ISLAND                                | NOK          | Norwegian Krone               |
| COOK ISLANDS (THE)                           | NZD          | New Zealand Dollar            |
| OMAN                                         | OMR          | Rial Omani                    |
| PANAMA                                       | PAB          | Balboa                        |
| PERU                                         | PEN          | Nuevo Sol                     |
...
| SURINAME                                     | SRD          | Surinam Dollar                |
| EL SALVADOR                                  | SVC          | El Salvador Colon             |
| SWAZILAND                                    | SZL          | Lilangeni                     |
| THAILAND                                     | THB          | Baht                          |
| TAJIKISTAN                                   | TJS          | Somoni                        |
| TURKMENISTAN                                 | TMT          | Turkmenistan New Manat        |
| TUNISIA                                      | TND          | Tunisian Dinar                |
| TONGA                                        | TOP          | Pa’anga                       |
| TURKEY                                       | TRY          | Turkish Lira                  |
| TRINIDAD AND TOBAGO                          | TTD          | Trinidad and Tobago Dollar    |
| TAIWAN (PROVINCE OF CHINA)                   | TWD          | New Taiwan Dollar             |
| TANZANIA, UNITED REPUBLIC OF                 | TZS          | Tanzanian Shilling            |
