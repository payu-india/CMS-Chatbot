...
[block:parameters]
{
  "data": {
    ...
    "10-1": "`String`This parameter is set to** 1** to pre-authorize payment using PayU Hosted Checkout.",
    "10-2": "",
    "11-0": "<<glossary:hash>>  \n`mandatory`",
    "11-1": "`String`It is the hash calculated by the merchant. The hash calculation logic is:` sha512(key\\|txnid\\|amount\\|productinfo\\|firstname\\|email\\|udf1\\|udf2\\|udf3\\|udf4\\|udf5\\||\\||\\||SALT)`  \n**Reference**: For detailed information on hashing, refer to  <a href=\"generate-hash-payu-hosted\" target=\"_blank\"> Generate Hash</a> . ",
    "11-2": "",
    "12-0": "address1  \n`optional`",
    ...
    "13-2": "34 Saikripa-Estate, Tilak Nagar",
    "14-0": "city  \n`optional`",
    ...
    "16-2": "India",
    "17-0": "zipcode  \n`optional`",
    "17-1": "`String` Billing address zip code is mandatory for the cardless EMI option.  <br>`Character Limit-20`",
    "17-2": "400004",
    "18-0": "enforced_payment  \n`optional`",
    "18-1": "`String`This parameter is to customize the payment options for each transaction. You can enforce specific payment modes, cards scheme, and specific banks under Net Banking using this method.",
    "18-2": "creditcard|debitcard",
    "19-0": "drop_category  \n`optional`",
