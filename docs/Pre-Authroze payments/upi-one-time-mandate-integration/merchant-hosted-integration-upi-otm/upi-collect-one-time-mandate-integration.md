...
[block:parameters]
{
  "data": {
    ...
    "8-2": "",
    "9-0": "pg  \n`mandatory`",
    "9-1": "It defines the payment category for which you wish to perform UPI One-Time Mandate integration. For UPI, **pg= UPI**",
    "9-2": "UPI",
    "10-0": "bankcode  \n`mandatory`",
    "10-1": "It defines the bank with which you wish to perform UPI Collect One-Time Mandate integration using the bank code. For UPI Collect, use **UPI**.",
    "10-2": "UPI",
