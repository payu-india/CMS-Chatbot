...
[block:parameters]
{
  "data": {
    ...
    "9-2": "UPI",
    "10-0": "bankcode  \n`mandatory`",
    "10-1": "It defines the bank with which you wish to perform UPI Intent One-Time Mandate integration using the bank code. For UPI Intent, use **INTENT**.",
    "10-2": "UPI",
    "11-0": "txn_s2s_flow  \n`mandatory`",
    "11-1": "This parameter must be passed with the values as **4** for UPI Intent.",
    "11-2": "",
