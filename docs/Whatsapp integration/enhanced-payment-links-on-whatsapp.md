...
---
---
title: Enhanced Payment Links (EPL) on WhatsApp
excerpt: ''
deprecated: false
hidden: false
metadata:
  title: Enhanced Payment Links (EPL) on WhatsApp with PayU
  description: >-
    Overview of PayU Enhanced Payment Links (EPL) on WhatsApp: how the flow
    works, how EPL compares to UPI Intent and PG Deep Integration, go-live
    requirements, and when to choose EPL for collections, insurance, lending,
    and other use cases.
  keywords:
    - Enhanced Payment Links
    - EPL WhatsApp
    - WhatsApp payment links PayU
    - WhatsApp template payment CTA
    - PayU WhatsApp collections
  robots: index
next:
  description: ''
---
...
## Requirements to go live on EPL
...
## Compare WhatsApp payment options
...
* [WhatsApp Payments Integration](doc:whatsapp-native-payments) — native in-chat payments positioning and prerequisites hub.
* [Integrate WhatsApp Payments](doc:integrate-whatsapp-payments) — BSP / WhatsApp Business APIs and linking PayU where required for native flows.
* [Link PayU with WhatsApp Business Account](doc:link-payu-with-whatsapp-business-account) — OAuth and Direct Pay setup for **self-owned** WABA (relevant when you move beyond EPL to deep integration).
...
| Term | Meaning |
| :--- | :--- |
| **WABA** | WhatsApp Business Account used with Cloud API at scale. |
| **EPL** | Enhanced Payment Links — pay via template CTA → hosted checkout. |
| **GK biglist** | Meta allowlist for EPL; WABA must be added for access. |
| **BSP** | Business Solution Provider — partner that helps with WABA and Cloud API. |
| **PG Deep Integration** | In-chat checkout via PG and Meta `payment_configuration`; OAuth required. |
