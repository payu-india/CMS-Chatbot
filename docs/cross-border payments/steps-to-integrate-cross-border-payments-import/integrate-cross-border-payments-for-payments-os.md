...
> 📘 **Reference**:
>
> For more information on **Create Charge** request, refer to the [PayU Payments OS](https://developers.paymentsos.com/docs/connect/payu-countries-and-regions/payu-india.html#implementing-an-opgsp-flow) documentation.
