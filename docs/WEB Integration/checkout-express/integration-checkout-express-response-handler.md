...
<Table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        This parameter holds the status of a transaction in PayU's internal database, which can include intermediate states. Possible values include: dropped, bounced, captured, auth, failed, usercancelled, or pending. For information on status description, refer to <a href="payment-state-explanations" target="_blank">Payment State Explanations</a>.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        This parameter contains the error message. For the list of error message, refer to <a href="error-codes" target="_blank">Error Codes</a>. 
      </td>
    </tr>
