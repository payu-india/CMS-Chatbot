---
title: Integrate CommercePro Checkout using Response Handler
excerpt: ''
deprecated: false
hidden: false
metadata:
...
[block:parameters]
{
  "data": {
    ...
    "4-0": "unmappedstatus",
    "4-1": "This parameter holds the status of a transaction in PayU's internal database, which can include intermediate states. Possible values include: dropped, bounced, captured, auth, failed, usercancelled, or pending. For information on status description, refer to <a href=\"payment-state-explanations\" target=\"_blank\">Payment State Explanations</a>.",
    "5-0": "key",
    ...
    "7-0": "error_Message",
    "7-1": "This parameter contains the error message. For the list of error message, refer to <a href=\"error-codes\" target=\"_blank\">Error Codes</a>. ",
    "8-0": "bank\\_ref\\_num",
