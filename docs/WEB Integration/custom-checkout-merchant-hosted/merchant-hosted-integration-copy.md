...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td>Merchant key provided by PayU during onboarding. <code>String</code></td>
            <td>JPG****.k</td>
        </tr>
        <tr>
            <td>txnid <code>[mandatory]</code></td>
            <td>The transaction ID is a reference number for a specific order generated by the merchant. <code>String</code> (25 characters)</td>
            <td>ypl938459435</td>
        </tr>
        <tr>
            <td>amount <code>[mandatory]</code></td>
            <td>The payment amount for the transaction. <code>Float</code></td>
            <td>10.00</td>
        </tr>
        <tr>
            <td>productinfo <code>[mandatory]</code></td>
            <td>A brief description of the product. <code>String</code> (100 characters)</td>
            <td>iPhone</td>
        </tr>
        <tr>
            <td>firstname <code>[mandatory]</code></td>
            <td>The first name of the customer. <code>String</code> (60 characters for production, 20 characters for test environment)</td>
            <td>Ashish</td>
        </tr>
        <tr>
            <td>email <code>[mandatory]</code></td>
            <td>The email address of the customer. <code>String</code> (50 characters)</td>
            <td>test@payu.in</td>
        </tr>
        <tr>
            <td>phone <code>[mandatory]</code></td>
            <td>The phone number of the customer. <code>String</code> (50 characters)</td>
            <td>9876543210</td>
        </tr>
        <tr>
            <td>pg <code>[mandatory]</code></td>
            <td>Payment gateway/method identifier. This is the key difference from hosted checkout. <code>String</code></td>
            <td>CC, NB, UPI, CASH</td>
        </tr>
        <tr>
            <td>bankcode <code>[mandatory]</code></td>
            <td>Bank or payment provider specific code. Required for specific payment methods. <code>String</code></td>
            <td>HDFC, PAYTM, UPI</td>
        </tr>
        <tr>
            <td>surl <code>[mandatory]</code></td>
            <td>The success URL, which is the page PayU will redirect to if the transaction is successful. <code>String</code> (50 characters)</td>
            <td>https://yoursite.com/success</td>
        </tr>
        <tr>
            <td>furl <code>[mandatory]</code></td>
            <td>The failure URL, which is the page PayU will redirect to if the transaction fails. <code>String</code> (50 characters)</td>
            <td>https://yoursite.com/failure</td>
        </tr>
        <tr>
            <td>hash <code>[mandatory]</code></td>
            <td>It is the hash calculated by the merchant using SHA-512. <code>String</code></td>
            <td>[computed hash]</td>
        </tr>
    </tbody>
</table>
`}</HTMLBlock>
 ...
 <details>
      <summary>Debit Card pg and bankcode</summary>
**Debit Card Codes**

| **Debit Card** | **pg** | **bankcode** |
| -------------- | ------ | ------------ |
| Visa           | DC     | VISA         |
| Mastercard     | DC     | MAST         |
| Maestro        | DC     | MAES         |
...
| SBI Maestro    | DC     | SMAE         |
 ...
 <details>
      <summary>Credit Card  pg and bankcode</summary>
**Credit Card Codes**

| **Credit Card**  | **pg** | **bankcode** |
| ---------------- | ------ | ------------ |
| Visa, Mastercard | CC     | CC           |
| Amex             | CC     | AMEX         |
| Diners           | CC     | DINR         |
| Rupay            | CC     | RUPAYCC      |
</details>
 ...
 <details>
      <summary>Net Banking Codes</summary>
| Bank Name                                  | bankcode |
| ------------------------------------------ | -------- |
...
| Capital Small Finance Bank Corporate       | CSFBC    |
| Capital Small Finance Bank Retail          | CSFBR    |
...
| DCB Bank                                   | DCBB     |
| Deutsche Bank                              | DSHB     |
| Dhanlaxmi Bank - Corporate                 | DLNBCORP |
| Dhanlaxmi Bank - Retail                    | DLSB     |
| Federal Bank                               | FEDB     |
| Federal Bank Corporate                     | FEDCORP  |
| HDFC Bank                                  | HDFB     |
| HDFC Bank - Corporate Banking              | HDFCCONB |
| ICICI Bank                                 | ICIB     |
| ICICI Corporate Netbanking                 | ICICICNB |
| IDBI Bank                                  | IDBB     |
| IDBI Corp Netbanking                       | IDBICORP |
| IDFC FIRST Bank                            | IDFCNB   |
| Indian Bank                                | INDB     |
| Indian Bank (Erstwhile Allahabad Bank)     | ALLB     |
| Indian Overseas Bank                       | INOB     |
| IndusInd Bank                              | INIB     |
| Jammu & Kashmir Bank                       | JAKB     |
...
| KVB NB TPV                                 | KVBNBTPV |
| Paytm Payments Bank                        | PAYTMNB  |
| PNB (Erstwhile -Oriental Bank of Commerce) | OBCB     |
| PNB (Erstwhile-United Bank of India)       | UNIB     |
| Post Office Savings Bank (POSB)            | INDPOST  |
| Prime Co Op Bank Ltd                       | PMEC     |
| Punjab & Sind Bank                         | PSBNB    |
| Punjab National Bank                       | PNBB     |
| Punjab National Bank - Corporate Banking   | CPNB     |
| RBL Bank                                   | RBLNB    |
| RBL Corporate Netbanking                   | RBLCNB   |
| Saraswat Bank                              | SRSWT    |
| Shivalik Small Finance Bank                | SHIVANB  |
| South Indian Bank                          | SOIB     |
| Standard Chartered Bank                    | SCBNB    |
| State Bank of India                        | SBIB     |
| State Bank of India (Corporate)            | SBNCORP  |
| SVC Co-operative Bank Ltd.                 | SVCNB    |
...
| Yes Bank                                   | YESB     |
    ...
    <Tab title="📱 UPI">
      ...
      * Smart Intent Flow
<details>
      <summary>Supported UPI Handles</summary>
...
<details>
      <summary>Supported Wallet Codes*</summary>
...
> Reference: For the list of bankcodes for EMI, refer to [EMI Codes](doc:emi-codes)
