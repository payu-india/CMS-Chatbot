...
[block:parameters]
{
  "data": {
    ...
    "7-1": "`String` It defines the payment category that the merchant wants the customer to see by default on the PayU’s payment page. This field must contain the value as \"UPI\" for UPI transactions.",
    "7-2": "UPI",
    "8-0": "<<glossary:bankcode>> `mandatory`",
    "8-1": "`String` Each payment option is identified with a unique bank code at PayU. The merchant must post this parameter with the corresponding payment option’s bank code value in it. For a detailed list of bank codes, please contact the PayU Support.",
    "8-2": "UPI",
    "9-0": "vpa  \n`mandatory`",
    "9-1": "String The VPA of the customer. For the list of bank name part of the handles, refer to [UPI Handles](doc:upi-handles) . **Reference**: For the list of test card numbers for EMI, refer to [Test Cards, UPI ID and Wallets](doc:test-cards-upi-id-and-wallets) ",
    "9-2": "test123@okhdfcbank",
    "10-0": "furl  \n`mandatory`",
    "10-1": "`String`The success URL, which is the page PayU will redirect to if the transaction is successful.",
    "10-2": "",
    "11-0": "surl  \n`mandatory`",
    "11-1": "`String`The Failure URL, which is the page PayU will redirect to if the transaction is failed.",
    "11-2": "",
    "12-0": "hash  \n`mandatory`",
    "12-1": "`String`It is the hash calculated by the merchant. The hash calculation logic is:  \n`sha512(key\\|txnid\\|amount\\|productinfo\\|firstname\\|email\\|udf1\\|udf2\\|udf3\\|udf4\\|udf5\\||\\||\\||SALT)`",
    "12-2": "",
    "13-0": "address1  \n`optional`",
