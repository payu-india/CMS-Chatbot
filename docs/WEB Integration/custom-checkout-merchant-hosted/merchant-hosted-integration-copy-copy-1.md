...
<Image align="center" border={false} src="https://files.readme.io/62944ec7a9993a09846ca63c11c98e190c78a119f134f9c679b0a0ebf4f39875-payment-modes-map.png" />
...
<Accordion title="Step 1.2: Prepare the request parameters" icon="fa-cogs">
  **Common Parameters (Required for all payment modes)**
  ...
  <HTMLBlock>{`
    <img src="" alt="Payment Methods" usemap="#paymentmap" style="width: 100%; height: auto;">
