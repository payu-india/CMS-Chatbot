...
[block:parameters]
{
  "data": {
    ...
    "7-1": "_String_ It defines the payment category using the Merchant Hosted Checkout integration. For a Wallet payment, \"CASH\" must be specified in the **pg** parameter.",
    "7-2": "CASH",
    "8-0": "<<glossary:bankcode>> `mandatory`",
    "8-1": "_String_ The merchant must post this parameter with the corresponding payment option’s bank code value in it. For all the supported wallets, refer to  <a href=\"wallet-codes\" target=\"_blank\"> Wallet Codes</a> to understand exact value which needs to be passed against **bankcode** parameter. **Reference**: For the list of test wallets, refer to <a href=\"test-cards-upi-id-and-wallets\" target=\"_blank\">Test Cards, UPI ID and Walletss</a> .",
    "8-2": "PAYTM",
    "9-0": "vpa  \n`mandatory`",
    "9-1": "`String` The VPA of the customer. For the list of bank name part of the handles, refer to <a href=\"upi-handles\" target=\"_blank\"> UPI Handles</a>. **Reference**: For the list of test card numbers for EMI, refer to <a href=\"test-cards-upi-id-and-wallets\" target=\"_blank\">Test Cards, UPI ID and Walletss</a> .",
