...
hidden: false
metadata:
  title: Generate Hash for PayU Hosted Checkout
  description: >-
    The page you are referring to is about generating hash for PayU Hosted
    Checkout. The page provides information on how to generate a hash value for
    a payment request using the SHA-512 hash function that belongs to the SHA-2
    family of cryptographic functions. The hash is used to protect transactions
    against a “man-in-the-middle-attack” 1.
  robots: index
next:
  description: ''
---
To ensure the security of transactions, PayU requires a hash to be generated for each transaction. This hash is used to verify the authenticity of the transaction data. The hash is used to protect transactions against a “man-in-the-middle-attack.”  
...
- <<glossary:key>>: Your merchant key (Test or Production key). 
- txnid: Unique transaction ID 
- amount: Transaction amount 
- productinfo: Product information 
- firstname: Customer's first name 
- email: Customer's email ID 
- <<glossary:Salt>>: Your Salt (Test or Production)
...
<details><summary>Tips for Hashing</summary>
