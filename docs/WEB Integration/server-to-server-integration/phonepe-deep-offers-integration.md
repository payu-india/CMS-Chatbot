...
The parameter list includes: mihpayid, mode, status, key, txnid, amount, productinfo, firstname, lastname, address1, address2, cit y, state, country, zipcode, email, phone, udf1, udf2, udf3, udf4, udf5, udf6, udf7, udf8, udf9, udf10, car d\_token,card\_no, field0, field1, field2, field3, field4, field5, field6, field7, field8, field9, offer, discou nt, offer\_availed,unmappedstatus, hash, bank\_ref\_no, surl, curl, furl, and card\_hash
