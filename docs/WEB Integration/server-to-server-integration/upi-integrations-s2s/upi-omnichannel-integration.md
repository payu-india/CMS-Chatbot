...
<tr>
  ...
  <td style="border: 1px solid #ddd; padding: 8px;"><p><code>String</code> It is used to avoid the possibility of transaction tampering. For more information, refer to <a href="doc:generate-hash-merchant-hosted">Generate Hash</a>.</p>
</td>
