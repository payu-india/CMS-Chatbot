...
## Step 5: Handle Insufficient Balance (Add Money & Debit)

When the wallet balance is insufficient, use the Add Money & Debit API to allow users to load money and complete the transaction in a single flow.
...
<table>
  ...
  <tbody>
    <tr>
      <td>Test</td>
      <td><code>https://test.mobikwik.com/walletapis/addmoneytowalletanddebit</code></td>
    </tr>
    <tr>
      <td>Production</td>
      <td><code>https://api.mobikwik.com/walletapis/addmoneytowalletanddebit</code></td>
    </tr>
  </tbody>
</table>
`}</HTMLBlock>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>User's wallet token</td>
    </tr>
    <tr>
      <td>redirectURL<br/><code>mandatory</code></td>
      <td>URL to redirect after transaction</td>
    </tr>
    <tr>
      <td>checksum<br/><code>mandatory</code></td>
      <td>HMAC SHA256 hash</td>
...
<Accordion title="Sample request" icon="fa-code">
```bash
curl --location 'https://test.mobikwik.com/walletapis/addmoneytowalletanddebit' \
--header 'Content-Type: application/x-www-form-urlencoded' \
--data-urlencode 'mid=YOUR_MERCHANT_ID' \
--data-urlencode 'amount=1000.00' \
--data-urlencode 'cell=9560012582' \
--data-urlencode 'token=TKN_ABC123XYZ789' \
--data-urlencode 'redirectURL=https://yoursite.com/payment-success' \
--data-urlencode 'checksum=GENERATED_CHECKSUM'
```
</Accordion>
...
Verify the transaction status using the Check Status API.
...
<table>
  ...
  <tbody>
    <tr>
      <td>Test</td>
      <td><code>https://test.mobikwik.com/checkstatus</code></td>
    </tr>
    <tr>
      <td>Production</td>
      <td><code>https://api.mobikwik.com/checkstatus</code></td>
    </tr>
  </tbody>
</table>
`}</HTMLBlock>
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>orderid<br/><code>mandatory</code></td>
...
<Accordion title="Sample request" icon="fa-code">
```bash
curl --location 'https://test.mobikwik.com/checkstatus' \
--header 'Content-Type: application/x-www-form-urlencoded' \
--data-urlencode 'mid=YOUR_MERCHANT_ID' \
--data-urlencode 'orderid=ORD123456' \
--data-urlencode 'checksum=GENERATED_CHECKSUM'
```
</Accordion>
...
Process refunds using the standard PayU refund mechanism. Refunds are processed in the T+1 settlement cycle.
...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Set to 'cancel_refund_transaction'</td>
    </tr>
    <tr>
...
<Accordion title="Note" icon="fa-info-circle">
Follow the standard PayU refund process for Mobikwik Link & Pay transactions.
</Accordion>
