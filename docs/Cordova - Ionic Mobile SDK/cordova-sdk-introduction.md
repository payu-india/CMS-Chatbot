...
1. [Integration Steps](https://docs.payu.in/docs/cordova-checkoutprosdk-integration-steps)
2. [Test the Integration](https://docs.payu.in/docs/cordova-checkoutprosdk-test-integration)
3. [Go-live Checklist](https://docs.payu.in/docs/cordova-checkoutprosdk-go-live-checklist)