...
- **\_payment** API: The Payment Consent Transaction using \_payment API  is used. For integrating using various integrations, refer to:
  - [Payment Consent Transaction using PayU Hosted Checkout](https://docs.payu.in/v2/reference/v2-payment-consent-transaction-payu-hosted-checkout)
  ...
  - [UPI Recurring Payment Consent Transaction](https://docs.payu.in/v2/reference/v2-upi-recurring-payment-consent-transaction)
- **pre\_debit\_SI** API: The [Pre-Debit Notification API](https://docs.payu.in/v1/reference/pre_debit_notification_api) section describes how to use this API to notify the customers before a recurring transaction.
...
- [Check Mandate Status API](https://docs.payu.in/v1/reference/check-mandate-status-api)
- [Modify the Recurring Payments for a Card](https://docs.payu.in/v1/reference/modify-the-recurring-payments-for-a-card)
- [Cancel the Recurring Payment for Cards](https://docs.payu.in/v1/reference/cancel-the-recurring-payment-for-cards)
...
- [Cancel the Recurring Payment for Net Banking](https://docs.payu.in/v1/reference/cancel-the-recurring-payment-for-net-banking)
- [Check the Net Banking Mandate Status API](https://docs.payu.in/v1/reference/net_banking_mandate_status_api)

## Manage Recurring Payment for UPI

The following API commands are applicable only for UPI:

- **upi\_mandate\_status**: Used to understand the current state of the UPI mandate at any time. For more information, refer to [Get Mandate Status API (for UPI only)](https://docs.payu.in/v1/reference/get-mandate-status-api-for-upi-only).
- **upi\_mandate\_modify**: Used to modify an existing UPI Recurring Payment Registration. For more information, [Modify the Recurring Payment for UPI](https://docs.payu.in/v1/reference/modify-the-recurring-payment-for-upi).
- **upi\_mandate\_revoke**: Used to cancel a UPI Recurring Payment Registration. For more information, refer to  [Cancel the Recurring Payment for UPI](https://docs.payu.in/v1/reference/cancel-the-recurring-payment-for-upi).