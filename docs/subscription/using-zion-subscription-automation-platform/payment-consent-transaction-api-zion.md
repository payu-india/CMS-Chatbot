---
title: Payment Consent Transaction API for Zion
excerpt: ''
deprecated: false
hidden: false
metadata:
...
next:
  description: ''
---
The Payment Consent Transaction API for Zion is same in Recurring Payments. The following APIs are used for Zion:
