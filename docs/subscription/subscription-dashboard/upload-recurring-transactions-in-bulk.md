...
<Image align="center" className="border" border={true} src="https://files.readme.io/d726f25bdae3121caf08b5c6cc35285c3bfd52f31d17da20589d8b4a509b7efc-dashboard-subscription-recurring-upload-selection.png" />

5. Click **Continue**. 

> **Note:** Download the sample file for registration or mandate using the **Download** button. 

<Image align="center" className="border" border={true} src="https://files.readme.io/9a8f99c19f1cb452a9bf8de652208e39027cc54ff53fd47836480a3326c14fbd-dashboard-subscription-recurring-bulk-upload.png" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/9870655ee9e9176030cb0cbd99f85e9dece3aabbda328c6f8be8d871d1b31bab-dashboard-subscription-recurring-bulk-upload-error.png" />
