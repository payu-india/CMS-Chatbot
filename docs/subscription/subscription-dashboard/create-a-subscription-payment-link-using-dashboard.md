...
<Image align="center" className="border" border={true} src="https://files.readme.io/545038dbe2e70d43d372c535a0119737e3906a391ac9997f8e4849df0e4bf0fb-dashboard-subscriptions-overview.png" />

The *Create Subscriptions* pop-up page is displayed.  

<Image align="center" className="border" border={true} src="https://files.readme.io/b636dc66b0417d5efe8ba893acee8df827b497ca8529b25896101043db02ff94-dashboard-create-subscriptions-link.png" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/d96b936829b1fbe8374f93454a56950923b3f193c6490d9acaf7d8229229e552-dashboard-create-subscriptions-link-step2.png" />
...
> 📘 Notes:
>
> * For eNACH, mandate start date needs to be atleast (T+1). Eg: In case the payment link is created today then the start date can be anything starting tomorrow.
...
<Image align="center" className="border" border={true} src="https://files.readme.io/c1793fdccafad7071dec9571fc10d91f79bac92777d290009408865b2335277f-dashboard-create-subscriptions-link-step3.png" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/353f05dc0c6fb1cc0899f2e8604d624455d32b2c65d8ce376f165a00834d4fab-Screenshot_2024-09-16_at_10.28.47_AM.png" />
...
1. Expand the **Addiitonal details** pane. 

<Image align="center" className="border" border={true} src="https://files.readme.io/a573ee878a78eb38b0e7f3b7a7cfb0c51d49ea82b4efd632f1d49b7dc12b85ba-dashboard-create-subscriptions-link-step4-addl-info.png" />
