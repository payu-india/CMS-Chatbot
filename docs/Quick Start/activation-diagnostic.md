...
metadata:
  robots: index
---
# What is Stopping Your First Payment?

Most integrations move through the same stages:

**Account → Verification → Credentials → Integration → Test payment → Production readiness → Production attempt → Successful payment**
