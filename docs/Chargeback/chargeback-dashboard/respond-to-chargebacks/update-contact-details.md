...
metadata:
  robots: index
---
Maintain current contact information to receive timely chargeback notifications. All chargeback notifications, fraud alerts, and dispute communications are sent to registered email addresses. Outdated contact information can result in:
