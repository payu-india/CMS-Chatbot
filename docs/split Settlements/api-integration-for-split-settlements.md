...
* Split After Transaction
  * [Absolute Split After Transaction using **payment\_split** API](https://docs.payu.in/v1/reference/absolute-split-after-transaction)
  * [Split by Percentage after Transaction using **payment\_split** API](https://docs.payu.in/v1/reference/split-by-percentage-after-transaction)
