---
title: Track the Efficiency of Campaigns
deprecated: false
hidden: true
metadata:
  robots: index
---
You can check or update the details of an existing campaign and customer transactions as a result of a campaign.
