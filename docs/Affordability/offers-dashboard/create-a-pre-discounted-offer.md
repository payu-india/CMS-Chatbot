...
4. [Configure the payment modes which can avail the offer](#step-4-configure-payment-modes)
...
The _Preview of Cashback Offer_ page summarizes the details you provided in [Step 2](#step-2-add-basic-details) to [Step 4](#step-4-configure-payment-modes).
