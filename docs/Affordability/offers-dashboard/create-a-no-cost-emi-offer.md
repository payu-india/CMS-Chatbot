...
1. Enter the offer rules and limitations on the _Set Offer Rules_ page. For more information, refer to [Create an Instant Discount or Cashback Offer](doc:create-an-offer).
2. After you complete the above details and click **Save & Process**.
...
The _Preview of Cashback Offer page summarizes the details you_ provided in Step 2 to Step 4.
