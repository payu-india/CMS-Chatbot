...
metadata:
  ...
  description: >-
    Enhance your e-commerce platform with PayU’s Recommendation Engine. Discover
    how our AI-driven tool increases payment success rates, optimizes checkout
    experiences, and boosts merchant conversions. Start personalizing customer
    payment options today.
  keywords:
    - PayU Recommendation Engine
    - Personalized Payment Experience
    - Payment Success Rates
    - User Drop Reduction
    - Payment Checkout Optimization
    - Merchant Conversion Improvement
    - Payment Instrument Personalization
