...
next:
  description: ''
---
This section describes the general steps to integrate <<glossary:BNPL>>.
...
For request parameters and response to perform BNPL Eligibility Check, refer to [Get Checkout Details API](ref:get_checkout_details).
