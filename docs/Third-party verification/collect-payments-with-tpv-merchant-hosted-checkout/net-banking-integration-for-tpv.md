...
<Table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <code>String</code> It defines the payment category for which you wish to perform TPV. For Net Banking, pg= 'NB'.
      </td>
    ...
    <tr>
      ...
      <td>
        <code>String</code> It defines the bank with which you wish to perform TPV using the bank code. For more information on the list of bank codes, refer to [Bank Codes for TPV](doc:bank-codes-for-tpv)
      </td>
    ...
    <tr>
      ...
      <td>
        ...
        <code>sha512(key|txnid|amount|productinfo|firstname|email|udf1|udf2|udf3|udf4|udf5|||||||beneficiarydetail|SALT)</code>
      </td>
