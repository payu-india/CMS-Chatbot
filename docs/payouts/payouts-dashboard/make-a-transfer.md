...
![](https://devguide.payu.in/wordpress/wp-content/uploads/2021/08/image-217-1024x758.png)

   The *Make a Transfer* page is displayed.

![](https://devguide.payu.in/wordpress/wp-content/uploads/2021/08/image-218-1024x535.png)

2. Select any of the following options from Single Payout or Bulk Payout to make payout:
...
* **Bulk Payouts**: Transfer money to customers/receivers in bulk by uploading their information (mobile number/email address/bank account details (Account Number and IFSC code)/UPI (VPA) in CSV file format. There are *two* methods to initiate Bulk Payouts such as:
  ...
  * **Direct Transfer**: In this approach, you can send money using UPI (VPA) or Account Details of the customers/receivers. These details are uploaded on the Payouts Dashboard using a CSV file. According to the details, money is transferred in the corresponding Bank Account of each customer/receiver.\ <br />
