...
{
  "data": {
    "h-0": "OpenCart Version",
    "h-1": "PayUI Plugin  \n Download Link",
    "0-0": "OpenCart v3.0.2",
    "0-1": "[GitHub Location](https://github.com/payu-india/PayUbiz_Opencart/releases/tag/ver3.0.2)",
    "1-0": "OpenCart v3.0",
    "1-1": "[GitHub Location](https://github.com/payu-india/PayUbiz_Opencart/releases/tag/ver_3.0)",
    "2-0": "OpenCart v2.3",
    "2-1": "[GitHub Location](https://github.com/payu-india/PayUbiz_Opencart/releases/tag/ver_2.3)",
    "3-0": "OpenCart v2.2",
    "3-1": "[GitHub Location](https://github.com/payu-india/PayUbiz_Opencart/releases/tag/ver_2.2)",
    "4-0": "OpenCart v2.0",
    "4-1": "[GitHub Location](https://github.com/payu-india/PayUbiz_Opencart/releases/tag/ver_2.0)"
  },
  "cols": 2,
  "rows": 5,
  "align": [
...
[block:parameters]
{
  "data": {
    ...
    "h-1": "**Description**",
    "0-0": "Merchant ID INR",
    "0-1": "Enter the test key for the Test environment or the Production key for the Production environment.",
    "1-0": "Salt INR",
    "1-1": "Enter the test salt for the Test environment or Production salt for the Production environment.",
    "2-0": "Mode",
    "2-1": "Select any of the following gateway environments from the Mode drop-down list to which customer payment details will be redirected to.  \n  \n- Test: This is the Test environment and no actual fund transfer will take place.\n- Production: This is the Live environment. Use this value only for your website in production. Payments sent in the production environment will get processed. For more information, refer to [Generate Merchant Key and Salt](doc:generate-merchant-key-and-salt-on-payu-dashboard).",
    "3-0": "Status",
    "3-1": "Select Enable from the drop-down list to enable the module.",
    "4-0": "Payment Gateway",
    "4-1": "Select PayUBiz from the drop-down list if you want to redirect to the PayUbiz page for payments.",
    "5-0": "Bank Code",
    "5-1": "Select PayUBiz Bank Code from this drop-down list."
  },
  "cols": 2,
  "rows": 6,
  "align": [
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://devguide.payu.in/wordpress/wp-content/uploads/2021/09/Screenshot-2021-09-01-at-6.44.03-PM-1024x984.jpg",
        null,
        ""
      ],
      "align": "center",
