---
title: Configure RTO Settings - Shopify COD
excerpt: ''
deprecated: false
hidden: false
metadata:
...
<Image align="center" className="border" border={true} src="https://files.readme.io/bb0d8d3e1f25aaecc102fd2e51c686467d43875bf5a1df8e8056586087e72035-Dashboard_CommercePro_Config_tab.png" />

1. Click **Configure Now** on the RTO Settings page.

## Configure amount rule

1. Navigate to the  *RTO Settings* page.

The **Amount Rule** tab is displayed.

<Image align="center" className="border" border={true} src="https://files.readme.io/4381ffa6c7d65fda2f3387354f69658eef5341c5fc54f48281c8f77ec543b3e4-Dashboard_CP_RTO_Amount_Setting.png" />

2. Click the Edit button in the **Set COD amount rule** field.

The \_Set COD amount rule \_pop-up page is displayed.

<Image align="center" src="https://files.readme.io/e436f2cfb9e9a711910d853de4a7e3b0f15503139852ae40a7944245bb352f56-Dashboard_CP_RTO_Set_Amount.png" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/27b004e019ed641ecb366b340af94074482fecba1898d90b5d075e0d4c7a6f36-Dashboard_CP_RTO_Blacklist_tab.png" />

3. Click the **Manually Black** button.

The *Block Customers* pop-up page is displayed.

<Image align="center" src="https://files.readme.io/70244557416e1cab700be41398bc86f897fad96dbc1bfef3943105d120a4fad5-Dashboard_CP_RTO_Blacklist_Manually.png" />
...
3. Click the **Upload Blacklisted Customer** button.
   ...
   The *Upload Blacklisted Customer List* pop-up page is displayed.

<Image align="center" src="https://files.readme.io/94d2e5d2630209f53f6ca7419d801974e8d2a7814732e9400c0c2cbd77786aee-Dashboard_CP_RTO_Blacklist_in_Bulk.png" />
...
<Image align="center" className="border" border={true} src="https://files.readme.io/8afa69f377e29ddef87b9db6e33ff39086420c49f5b8f8d31afb3673c8db4338-Dashboard_CP_RTO_Whiteist_tab.png" />

3. Click the **Manually Whitelist** button.

The *Whitelist Customers* pop-up page is displayed.

<Image align="center" src="https://files.readme.io/9b6348d8a45397b1f41b88feb6c02c06b2b4fdeb3cc0572f7a84413a6547cc93-Dashboard_CP_RTO_Whiteist_manually.png" />
...
3. Click the **Upload Whitelisted Customer** button.
   ...
   The *Upload Whitelisted Customer List* pop-up page is displayed.

<Image align="center" src="https://files.readme.io/661d768ce2697a59ba15683e48e687e031c5742ee3c9a2e2047e519630ee65c0-Dashboard_CP_RTO_Whiteist_Bulk.png" />
