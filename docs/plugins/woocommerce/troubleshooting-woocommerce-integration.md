...
- Check whether the merchant API key and Salt are configured accurately and navigate to [Merchant Dashboard](http://onboarding.payu.in/) and verify these values. For more information, refer to [Configure WooCommerce Settings](#configure-woocommerce-settings). For more information on generating API key and salt, refer to [Generate Merchant Key and Salt on PayU Dashboard](doc:generate-merchant-key-and-salt-on-payu-dashboard)

> 📘 Note:
> 
> The Salt that you get from PayU is case-sensitive. It is recommended to copy the Salt from the Dashboard and paste it in **PayU Salt for Currency 1** field of the _PayUBiz payment_ page. For more information, refer to [Configure WooCommerce Settings](#configure-woocommerce-settings).

- Check whether the PHP curl extension is installed and activated.

## Unable to process your request

An error message similar to the following screenshot is displayed if the value entered in the **Currency 1** field of the _PayUBiz payment_ page is not in capital letters or blank. For more information, refer to [Configure WooCommerce Settings](#configure-woocommerce-settings).
...
[block:image]
{
  "images": [
    {
      "image": [
        "https://devguide.payu.in/wordpress/wp-content/uploads/2021/09/image-6-1024x694.jpg",
        null,
        ""
      ],
      "align": "center",
...
You may have not configured the **Return Page** field on the **Payments** tab during configuration. For more information, refer to [Configure WooCommerce Settings](#configure-woocommerce-settings).
