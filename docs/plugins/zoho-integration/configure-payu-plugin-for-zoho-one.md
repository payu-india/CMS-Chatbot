...
[block:image]{"images":[{"image":["https://devguide.payu.in/wordpress/index.php/wp-json/getobject?keyname=uploads/2022/02/ZohoBooks_Settings-1024x652.png",null,null],"align":"center","border":true}]}[/block]
...
4. Click **Setup now** under **PayU**.
   ...
   The _Configure Gateway_ dialog box is displayed.

[block:image]{"images":[{"image":["https://devguide.payu.in/wordpress/index.php/wp-json/getobject?keyname=uploads/2022/02/Setup_PayU_for_ZohoBooks-1024x630.png",null,null],"align":"center","border":true}]}[/block]
...
1. Navigate to **Sales** > **Invoice** on Zoho One.
   ...
   The _All Invoices_ page is displayed.

[block:image]{"images":[{"image":["https://devguide.payu.in/wordpress/index.php/wp-json/getobject?keyname=uploads/2022/02/Zohobooks_New_Invoice_option-1024x485.png",null,null],"align":"center","border":true}]}[/block]

2. Click the **New** button on the top-right corner.

   The _New Invoice_ page is displayed.

[block:image]{"images":[{"image":["https://devguide.payu.in/wordpress/index.php/wp-json/getobject?keyname=uploads/2022/02/ZohoBooks_New_Invoice-1024x457.png",null,null],"align":"center","border":true}]}[/block]
...
4. Click **Save and Send** after providing the details.  
   The _Email To \<Customer Name>_ page is displayed, where \<Customer Name> is substituted with the customer name specified in Step 3.

[block:image]{"images":[{"image":["https://devguide.payu.in/wordpress/index.php/wp-json/getobject?keyname=uploads/2022/02/ZohoBooks_Email_Voucher-1024x505.png",null,null],"align":"center","border":true}]}[/block]
