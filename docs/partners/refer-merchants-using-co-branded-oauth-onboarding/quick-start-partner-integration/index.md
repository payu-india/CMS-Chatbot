...
- **Partner credentials**: Client ID and Client Secret.  For more information, refer to [Download Client Credentials.](doc:download-client-credentials)
...
<Accordion title="Steps involved in flow" icon="fa-code">
...
<Accordion title="Steps involved in Co-Branded Onboarding" icon="fa-info-circle">
...
<Accordion title="Steps involved in Login Co-Branded Onboarding" icon="fa-info-circle">
...
<Accordion title="Steps to Enable Co-Branded Onboarding" icon="fa-info-circle">
...
- `state`: It is a custom field. It is optional.
- `email` (optional): It contains the partner email address. It is optional.

<Accordion title="Sample OAuth URL" icon="fa-code">
  ```
  https://onboarding.payu.in/app/account/signup?reseller_id=66ed-fc3c-512f47ed-ac95-4319452fbd89&state=1513493
  ```
</Accordion>
