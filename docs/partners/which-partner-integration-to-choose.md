...
| **Custom onboarding journey**       | Manual / portal-led                                  | Limited                                                    | PayU-hosted, co-branded                                                   | Full control via APIs                       |
...
| **Ideal when**                      | You want dashboard tools without building product UI | You only need to share a link and earn incentives          | You want branded onboarding without building KYC UI                       | Merchants must never leave your product     |
