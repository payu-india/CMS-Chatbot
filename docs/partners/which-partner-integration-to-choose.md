...
metadata:
  robots: index
---
Choose how you want to onboard merchants with PayU. Use this page to compare **Partner Portal**, **referral links,** **Co-Branded OAuth**, and **Merchant onboarding APIs** then follow the guide for your path.
...
| **Brand control**                   | Your logo + colours                                                       | Full                                        | None                                                 | None                                                       |
| **Technical effort**                | Low                                                                       | High                                        | None                                                 | None                                                       |
| **Merchant stays on your platform** | No (redirects to PayU, then back)                                         | Yes                                         | No                                                   | No                                                         |
| **Custom onboarding journey**       | PayU-hosted, co-branded                                                   | Full control via APIs                       | Manual / portal-led                                  | Limited                                                    |
| **Pre-fill merchant fields**        | Yes                                                                       | Yes                                         | No                                                   | No                                                         |
| **Redirection to PayU**             | Yes                                                                       | No                                          | Yes                                                  | Yes                                                        |
| **Redirection back to platform**    | Yes (with auth code)                                                      | Not required                                | No                                                   | No                                                         |
| **Authorisation model**             | Merchant consent; validate auth code                                      | Bearer token (`GetToken`)                   | Not applicable                                       | Not applicable                                             |
| **Best for**                        | Mid-size platforms                                                        | Large platforms                             | Manual onboarding                                    | Individual resellers                                       |
| **Ideal when**                      | You want branded onboarding without building KYC UI                       | Merchants must never leave your product     | You want dashboard tools without building product UI | You only need to share a link and earn incentives          |
