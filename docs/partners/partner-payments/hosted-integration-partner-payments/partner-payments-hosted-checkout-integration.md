...
<tr>
<td>txnid</td>
<td>The unique transaction ID generated by the merchant for each transaction.</td>
...
<tr>
<td>productinfo</td>
<td>The description of the product or service being purchased.</td>
...
<tr>
<td>merchant_id</td>
<td>The unique identifier of the merchant.</td>
<td>8739528</td>
</tr>
<tr>
<td>surl</td>
<td>The success URL to which the customer is redirected upon a successful payment.</td>
<td>https://yourplatform.com/payment/success</td>
</tr>
<tr>
<td>furl</td>
<td>The failure URL to which the customer is redirected upon a payment failure.</td>
<td>https://yourplatform.com/payment/failure</td>
</tr>
<tr>
<td>hash</td>
<td>A SHA-512 hash computed using the formula: sha512(key|txnid|amount|productinfo|firstname|email|udf1|udf2|udf3|udf4|udf5||||| ||<Glossary>Salt</Glossary>)</td>
<td>computed_sha512_hash_here</td>
</tr>
</tbody>
</table>
...
| :--- | :--- | :--- |
| reseller_id | The unique identifier of the reseller associated with the transaction. | 11ee-0e7e-5403fde2-9523-0a696b110fde |
| curl | The cancel URL to which the customer is redirected when a payment is cancelled. | https://yourplatform.com/payment/cancel |
| udf1 | User-defined field 1 to pass any additional information related to the transaction. | subscription_plan_premium |
| udf2 | User-defined field 2 to pass any additional information related to the transaction. | monthly_billing |
| udf5 | User-defined field 5 to pass any additional information related to the transaction. | partner_web_checkout |                                                           |
    <Warning>
    **Important:** All hash computations for partner payments use your OAuth `client_secret`, NOT the merchant salt used in direct merchant integrations.
    </Warning>
