...
<Accordion title="Request Body Parameters" icon="fa-table">
  **Mandatory Parameters**
  ...
  Here are the request parameter tables. The **Mandatory parameters** table uses **HTML format** (10 rows ≥ 6) and the **Optional parameters** table uses **Markdown format** (5 rows \< 6).
  ...
  ***
  ...
  5. **Customer Completes Payment** — Customer selects a payment method on PayU's hosted page, authenticates, and completes the

  **Optional parameters**

  | Parameter   | Description                                                              | Example                                                                            |
  | :---------- | :----------------------------------------------------------------------- | :--------------------------------------------------------------------------------- |
  | reseller_id | The unique reseller ID assigned by PayU.                                 | 11ee-0e7e-5403fde2-9523-0a696b110fde                                               |
  | curl        | The URL to which the customer is redirected if the payment is cancelled. | [https://yourplatform.com/payment/cancel](https://yourplatform.com/payment/cancel) |
  | udf1        | User-defined field 1 to pass any additional information.                 | subscription_plan_premium                                                          |
  | udf2        | User-defined field 2 to pass any additional information.                 | monthly_billing                                                                    |
  | udf5        | User-defined field 5 to pass any additional information.                 | partner_web_checkout                                                               |
...
<Accordion title="Sample Payload" icon="fa-code">
  ...
  **Sample Failure Webhook Payload:**
  ...
  ```
<Accordion title="Field Descriptions" icon="fa-code">
...
<table>
  ...
  <tbody>
    <tr>
      <td>key</td>
      <td>The merchant key assigned by PayU, returned in the webhook notification for identification.</td>
      <td>JPM7Fg</td>
    </tr>
    <tr>
      <td>txnid</td>
      <td>The unique transaction ID generated by the merchant, echoed back in the webhook notification.</td>
      <td>PPHOST20240315001</td>
    </tr>
    <tr>
      <td>mihpayid</td>
      <td>The unique payment ID generated by PayU for the transaction, returned in the webhook notification.</td>
      <td>403993715521899234</td>
    </tr>
    <tr>
      <td>status</td>
      <td>The final status of the transaction sent by PayU via the webhook notification.</td>
      <td>success</td>
    </tr>
    <tr>
      <td>amount</td>
      <td>The transaction amount echoed back in the webhook notification.</td>
      <td>1500.00</td>
    </tr>
    <tr>
      <td>productinfo</td>
      <td>The product or service description echoed back in the webhook notification.</td>
      <td>Premium Subscription - Monthly</td>
    </tr>
    <tr>
      <td>firstname</td>
      <td>The first name of the customer echoed back in the webhook notification.</td>
      <td>Priya</td>
    </tr>
    <tr>
      <td>email</td>
      <td>The email address of the customer echoed back in the webhook notification.</td>
      <td>priya.sharma@example.com</td>
    </tr>
    <tr>
      <td>phone</td>
      <td>The phone number of the customer echoed back in the webhook notification.</td>
      <td>919876543210</td>
    </tr>
    <tr>
      <td>merchant_id</td>
      <td>The unique merchant ID assigned by PayU, returned in the webhook notification.</td>
      <td>8739528</td>
    </tr>
    <tr>
      <td>error</td>
      <td>The error code returned by PayU in the webhook notification indicating the transaction outcome.</td>
      <td>No Error</td>
    </tr>
    <tr>
      <td>error_Message</td>
      <td>The error message returned by PayU in the webhook notification describing the transaction outcome.</td>
      <td>No Error</td>
    </tr>
    <tr>
      <td>hash</td>
      <td>The hash sent by PayU in the webhook notification for verification. Validate by computing SHA512(key\|txnid\|amount\|productinfo\|firstname\|email\|udf1\|udf2\|udf3\|udf4\|udf5\|\|\| \| \|\|&lt;Glossary&gt;Salt&lt;/Glossary&gt;) and comparing it against the received hash.</td>
      <td>webhook_hash_from_payu</td>
    </tr>
    <tr>
      <th style="text-align:left">Parameter</th>
      <th style="text-align:left">Description</th>
  ...
  <tbody>
    <tr>
      ...
      <td>The raw internal status of the transaction returned by the bank or payment network in the webhook notification.</td>
      <td>captured</td>
    </tr>
    <tr>
      <td>mode</td>
      <td>The payment mode used to complete the transaction, returned in the webhook notification.</td>
      <td>CC</td>
    </tr>
    <tr>
      <td>bankcode</td>
      <td>The bank or card network code associated with the transaction, returned in the webhook notification.</td>
      <td>VISA</td>
    </tr>
    <tr>
      <td>udf1</td>
      <td>User-defined field 1 passed during the payment request and echoed back in the webhook notification.</td>
      <td>subscription_plan_premium</td>
    </tr>
    <tr>
      <td>udf2</td>
      <td>User-defined field 2 passed during the payment request and echoed back in the webhook notification.</td>
      <td>monthly_billing</td>
    </tr>
    <tr>
      <td>udf3</td>
      <td>User-defined field 3 passed during the payment request and echoed back in the webhook notification.</td>
      <td></td>
    </tr>
    <tr>
      <td>udf4</td>
      <td>User-defined field 4 passed during the payment request and echoed back in the webhook notification.</td>
      <td></td>
    </tr>
    <tr>
      <td>udf5</td>
      <td>User-defined field 5 passed during the payment request and echoed back in the webhook notification.</td>
