...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>productinfo</td>
      <td>A brief description of the product or service.</td>
    ...
    <tr>
      <td>merchant_id</td>
      <td>The unique merchant ID assigned by PayU.</td>
      <td>8739528</td>
    </tr>
    <tr>
      <td>surl</td>
      <td>The URL to which the customer is redirected after a successful payment.</td>
      <td>https://yourplatform.com/payment/success</td>
    </tr>
    <tr>
      <td>furl</td>
      <td>The URL to which the customer is redirected after a failed payment.</td>
      <td>https://yourplatform.com/payment/failure</td>
    </tr>
    <tr>
      <td>hash</td>
      <td>The hash is computed using the SHA512 algorithm in the following format: SHA512(key\|txnid\|amount\|productinfo\|firstname\|email\|udf1\|udf2\|udf3\|udf4\|udf5\|\|\| \| \|\|&lt;Glossary&gt;Salt&lt;/Glossary&gt;)</td>
...
| curl | The URL to which the customer is redirected if the payment is cancelled. | https://yourplatform.com/payment/cancel |
