...
|                                     | [Partner Portal](docs:onboard-merchants-manually) | [Referral Link](docs:refer-merchants-using-referral-links) | [Co-Branded OAuth](doc:refer-merchants-using-co-branded-oauth-onboarding) | [API](doc:apis-used-in-partner-integration) |
| ----------------------------------- | ------------------------------------------------- | ---------------------------------------------------------- | ------------------------------------------------------------------------- | ------------------------------------------- |
...
| **Best for**                        | Manual onboarding                                 | Individual resellers                                       | Mid-size platforms                                                        | Large platforms                             |
