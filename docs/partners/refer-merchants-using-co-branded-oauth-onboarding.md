...
3. Based on the configuration (default/custom) saved in the backend, the journey of the merchants will be customized. Merchants can either sign up or log in through this page.
   * If the merchant is signing up, thy will be taken to the onboarding journey only if it is pending. On submitting the information, the user will be taken to a *Consent* page, where the user will be asked to allow access to the partner.
