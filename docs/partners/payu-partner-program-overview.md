...
| **Integration**  **Method**      | [API](/docs/refer-merchants)   | [Oauth](/docs/refer-merchants-using-co-branded-oauth-onboarding) | [Hyperlink](/docs/refer-merchants-using-referral-links) | [Partner Portal](/docs/partner-portal) |
