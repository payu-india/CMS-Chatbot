...
To configure the URLs and brand logo for a merchant:
...
8. Click **Browse** in the **Add a brand logo** field and select brand logo.

> **Note**: The brand logo should in JPG/JPEG, less than 5MB in size and width and height should be 90pixels.

9. Click the color chooser in the **Pick color** field for the theme.