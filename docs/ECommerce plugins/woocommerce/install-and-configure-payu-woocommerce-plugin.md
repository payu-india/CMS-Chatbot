...
<Table align={["left","left","left"]}>
  ...
  <tbody>
    <tr>
      ...
      <td>
        [GitHub Location](https://github.com/payu-india/Woocommerce/blob/main/WooCommerce_v41_PayUBiz.zip)
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        [GitHub Location](https://github.com/payu-india/Woocommerce/blob/main/WooCommerce_v381_MultiCurrency_PayUBiz.zip)
      </td>
    </tr>
  </tbody>
</Table>
...
<Image align="center" className="border" border={true} src="https://devguide.payu.in/wordpress/wp-content/uploads/2021/06/word-image-8.png" />
