...
> 📘 Reference:
>
> To configure the RTO settings, refer to [Configure RTO Settings](doc:configure-rto-settings-shopify-cod).

This part of the document includes the following sections:

* [Install CommercePro COD App](doc:install-commercepro-cod-app-shopify)
* [Configure RTO Settings](doc:configure-rto-settings-shopify-cod)
* [View COD Orders](doc:view-cod-orders-commercepro)

After a COD order is placed by your customer, you have to manually mark the order as paid after the order is completed or customer has paid. For more information, refer to [Mark an COD Order as Paid](doc:managing-cod-orders#mark-an-cod-order-as-paid).
