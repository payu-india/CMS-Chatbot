...
<tr>
  ...
  <td style="border: 1px solid #ddd; padding: 8px;"><p><code>String</code> This field must contain the payment mode code. For more information, refer to <a href="https://docs.payu.in/docs/payment-mode-codes">Payment Mode Codes</a>. For UPI, this must contain <strong>UPI</strong>.</p>
</td>
</tr>
<tr>
