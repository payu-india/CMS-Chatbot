...
> 
> If you have already integrated with **\_payment** (v1) API, refer to\[Merchant Hosted Checkout Integration v1\](<https://docs.payu.in/v1/docs/custom-checkout-merchant-hosted>).
