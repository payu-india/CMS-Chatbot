...
|-----------|------|-------------|----------|
| `accountId` | String | Merchant key provided by PayU during onboarding | Yes |
| `referenceId` | String | Unique transaction reference ID generated by the merchant | Yes |
| `currency` | String | Transaction currency (e.g., INR) | Yes |
| `paymentSource` | String | Payment source (e.g., WEB) | No |
| `paymentMethod` | Object | Payment method details including Net Banking specific parameters | Yes |
| `order` | Object | Order details including product information and pricing | Yes |
| `additionalInfo` | Object | Additional information including transaction flow settings | Yes |
| `callBackActions` | Object | Callback URLs for success, failure, and cancel scenarios | Yes |
| `billingDetails` | Object | Customer billing information | Yes |
