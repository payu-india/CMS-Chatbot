...
next:
  description: ''
---
PayU allows you to collect payments using UPI handles with seamless integration. For the list of UPI providers supported, refer to <Anchor label="UPI Handles" target="_blank" href="https://docs.payu.in/doc/upi-handles">UPI Handles</Anchor>.
