...
next:
  description: ''
---
PayU allows you to collect payments using UPI handles with seamless integration. For the list of UPI providers supported, refer to [UPI Handles](doc:upi-handles).
