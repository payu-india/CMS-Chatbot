...
<Accordion title="Where the Failure Happened" icon="far fa-question">
...
<Accordion title="Fields to Check" icon="far fa-file-spreadsheet">
...
<Accordion title="Do Not Log These" icon="far fa-do-not-enter">
  - Salt.
...
<Accordion title="Error Categories" icon="far fa-list-timeline">
...
<Accordion title="Logs Order" icon="far fa-list-timeline">
...
<Accordion title="Triage Checklist" icon="far fa-check-double">
