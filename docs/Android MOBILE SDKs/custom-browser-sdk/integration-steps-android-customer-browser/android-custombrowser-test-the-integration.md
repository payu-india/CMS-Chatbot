...
metadata:
  ...
  description: >-
    This document provides instructions on testing the integration of various
    payment methods, including Net Banking, UPI, EMI, and Wallets, before going
    live and accepting actual payments from customers.
  keywords:
    ...
    - Android CB SDK Integration Testing
    - PayU Android SDK Integration Testing
    - Test Mobile payment integration with PayU Android SDK
