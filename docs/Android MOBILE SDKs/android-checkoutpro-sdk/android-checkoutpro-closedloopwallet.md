...
2. Build the payment parameters with `additionalParamsMap[PayUCheckoutProConstants.WALLET_URN]` additional parameter. For more information, refer to [Integration Steps](doc:android-checkoutpro-integration-steps) of Android checkout pro SDK.
