...
<Image align="center" className="border" border={true} src="https://files.readme.io/e4fb62f4da41f7913d72ed32ad292fa6b317d6ae078e01920c67cfdbe63bf542-Screenshot_2025-06-02_at_7.43.06_PM.png" />
...
5. Select the customer from the **Billed To** drop-down list to whom the invoice is created for.
6. Click **Add item** to include the item details for the invoice.
7. In the tabular grid, select the item name from the **Enter Item Name** drop-down list.
...
<Image align="center" className="border" border={true} src="https://files.readme.io/3daf144fb955f8a78881701fc5da7331a02f3d8a3ceba2320c1e99ef698c198d-Screenshot_2025-06-02_at_7.47.23_PM.png" />
...
9. Select the following check boxes as required on the **Settings** pane:
...
> 📘 Note:
>
> You can save, send, or cancel the invoice using the options on the top-right corner of the page\_.\_
