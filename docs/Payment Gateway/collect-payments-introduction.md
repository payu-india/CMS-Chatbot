...
PayU also provides <Anchor label="no-code options" target="_blank" href="docs/introduction-no-code-payments-integration">no-code options</Anchor> to collect payments without integration.
