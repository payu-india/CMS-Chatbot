...
<Accordion title="Step 1: Prepare Request Parameters" icon="fa-info-circle">
  ...
  | **surl**       | `string` The success URL to which PayU redirects the user after a successful transaction. For example, `[https://test-payment-middleware.payu.in/simulatorResponse](https://test-payment-middleware.payu.in/simulatorResponse)`                                                                                                                                  |
