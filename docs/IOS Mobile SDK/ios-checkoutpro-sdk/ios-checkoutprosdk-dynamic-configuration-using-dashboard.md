...
Use the latest version of the Checkout Pro SDK and add/update the config on the PayU Dashboard. The changes will automatically reflect in your app. To enable this configuration, navigate to the following PayU Dashboard page: <https://www.payu.in/business/payment-gateway/sdk-settings>
