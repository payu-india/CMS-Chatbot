...
metadata:
  title: iOS Custom Browser SDK
  description: >-
    This document provides information on how to integrate CustomBrowser using
    different methods and perform steps such as making payments, customizing the
    browser, and releasing the app.
  keywords:
    - IOS Custom Browser SDK
    - PayU IOS SDK integration
    - Mobile payment integration with PayU IOS SDK
    - PayU IOS Custom Browser setup for Mobile
    - Custom Browser SDK for IOS
    - ' IOS CB SDK'
    - PayU IOS SDK integration
    - PayU IOS CB setup for Mobile
    - Custom Browser SDK for IOS
  robots: index
next:
  description: ''
