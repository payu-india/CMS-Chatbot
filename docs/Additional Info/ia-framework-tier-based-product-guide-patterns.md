...
## Mapping the Sprint to This Framework

The 4-week sprint builds the **launch scope** of this framework, not the full IA. Pages being deferred (Week 5+) are noted below.

| Product           | T1 Launch Pages (Sprint)                                                          | T1 Full IA (Future)                                      |
| ----------------- | --------------------------------------------------------------------------------- | -------------------------------------------------------- |
| Payment Links     | Overview, Get Started (via quickstarts), Create (via quickstart), Manage, Options | Troubleshooting, FAQs, sub-pages when needed             |
| UPI QR            | Overview, Create (via quickstart)                                                 | Get Started, Manage, How It Works, Troubleshooting, FAQs |
| WhatsApp Payments | Overview, Send (via quickstart)                                                   | Manage, Options, Troubleshooting, FAQs                   |
| COD               | Overview, Enable                                                                  | Troubleshooting, FAQs                                    |

| Product         | T2 Launch Pages (Sprint)                                       | T2 Full IA (Future)                                                                                                                        |
| --------------- | -------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------ |
| Hosted Checkout | Overview, Quickstart                                           | Get Started sub-pages, How It Works, Integration Guide, Customize, Test, Go Live, Best Practices, Troubleshooting, FAQs, Related Solutions |
| Plugins         | GoKwik (Integration Guide), Overview, Shopify (via quickstart) | WooCommerce, Magento, and remaining platforms using 7-page template                                                                        |

***

_IA Framework v1.0 — September 17, 2026. Based on tier strategy established in payu-docs-restructuring-plan.md. Reference competitor analysis: Razorpay, Adyen. Sprint implementation: payu-docs-4week-sprint-plan.md._
