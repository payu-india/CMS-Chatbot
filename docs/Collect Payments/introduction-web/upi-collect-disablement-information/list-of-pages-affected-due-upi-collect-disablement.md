---
title: List of Pages Affected due UPI Collect Disablement
deprecated: false
hidden: true
metadata:
  robots: index
...
* [UPI Collect One-Time Mandate Integration (PayU Hosted)](doc:upi-collect-one-time-mandate-integration-payu-hosted)
* [UPI Collect One-Time Mandate Integration](doc:upi-collect-one-time-mandate-integration)
* [UPI Collect Autopay TPV Integration](doc:upi-collect-autopay-tpv-integration)

<Callout icon="📌" theme="info">
  **Need Assistance?** For further details or assistance with migrating your integration, please contact our support team.
</Callout>
