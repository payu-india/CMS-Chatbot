...
<Cards columns={3}>
  <Card title="1. Add the inline script in the HTML Header" href="https://docs.payu.in/docs/checkout-plus-integration?isFramePreview=true#step-1-add-meta-tags--scripts-in-the-html-header" target="_blank">
