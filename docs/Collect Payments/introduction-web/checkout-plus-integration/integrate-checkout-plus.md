...
<Callout icon="👍" theme="okay">
  Experience the end-to-end **Checkout Plus** flow and instantly generate the complete code for seamless, zero-coding integration into your website.
  ...
  <HTMLBlock>{`
                    ...
                    <button onclick="window.open('payu.in/integrationlab/checkoutplus', '_blank')" 
                            class="tooltip-btn" 
