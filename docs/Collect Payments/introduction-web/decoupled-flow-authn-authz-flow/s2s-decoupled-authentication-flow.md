...
<Callout icon="📘" theme="info">
  For **Pre-Authorize (Auth and Capture) Payments**: You can include **pre_authorize** along with the following request parameters and then call the**Capture Transaction** API to capture the transaction. For more information on Pre-Authorize Payments with Cards , refer to <Anchor label="Pre-Authorize Payments > Credit Card" target="_blank" href="doc:credit-card-merchant-hosted-integration-pre-authorize-payment">Pre-Authorize Payments > Credit Card</Anchor>.
</Callout>
