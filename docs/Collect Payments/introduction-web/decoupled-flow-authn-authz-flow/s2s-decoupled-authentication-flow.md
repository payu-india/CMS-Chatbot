...
<Callout icon="📘" theme="info">
  **Reference for Error Codes**: For a list of authentication error codes, refer to [Error Codes](ref:error-codes).
</Callout>
...
For detailed API specifications, refer to [Auth Status Check API](ref:auth-status-check-api).
...
<Accordion title="Sample Request" icon="fa-code">
  ...
  ### Sample request to check authentication status for Cyber and Blazecard payment gateways
...
<Accordion title="Sample Response" icon="fa-reply">
  ```json
  {
      "payuid": 403993715537304372,
      "eci": "02",
      "cavv": "4zFbS6JGPLwyEqPmjw8b7FbPmJjN",
      "threeDSTransStatus": "Y",
      "threeDSTransStatusReason": null,
      "flowType": "challenge",
      "threeDSTransID": null,
      "threeDSServerTransID": "fac0a6f5-fc26-2c79-964e-eea4a9e27f33",
...
<Accordion title="Error List" icon="fa-info-circle">
  Refer to the <a href="https://docs.payu.in/reference/error-codes#authn-errors" target="_blank">AuthN Errors</a> section in the Error Codes page for the list of authentication errors.
</Accordion>
