...
<Accordion title="Usage examples" icon="fa-code">
  ...
  <Accordion title="Sample request with single category" icon="fa-code">
    ...
    **Debit Card only (`debitcard`)**
    ...
    # Parameters include key, txnid, amount, surl, furl, hash; enforce_paymethod=debitcard
    ```
    ```python
    import requests
    ...
    **Net Banking only (`netbanking`)**
    ...
    # Parameters include key, txnid, amount, surl, furl, hash; enforce_paymethod=netbanking
    ```
    ```python
    import requests
    ...
    **NEFT/RTGS only (`neftrtgs`)**
    ...
    # Parameters include key, txnid, amount, surl, furl, hash; enforce_paymethod=neftrtgs
    ```
    ```python
    import requests
    ...
    **EMI only (`emi`)**
    ...
    # Parameters include key, txnid, amount, surl, furl, hash; enforce_paymethod=emi
    ```
    ```python
    import requests
    ...
    **UPI only (`upi`)**
    ...
    # Parameters include key, txnid, amount, surl, furl, hash; enforce_paymethod=upi
    ```
    ```python
    import requests
    ...
    **Wallet / Cash Card only (`cashcard`)**
    ...
    # Parameters include key, txnid, amount, surl, furl, hash; enforce_paymethod=cashcard
    ```
    ```python
    import requests
    ...
    **Sodexo only (`SODEXO`)**
    ...
    # Parameters include key, txnid, amount, surl, furl, hash; enforce_paymethod=SODEXO
    ```
    ```python
    import requests
    ...
    **BNPL only (`bnpl`)**
    ...
    # Parameters include key, txnid, amount, surl, furl, hash; enforce_paymethod=bnpl
    ```
    ```python
    import requests
    ...
    **QR only (`qr`)**
    ...
    # Parameters include key, txnid, amount, surl, furl, hash; enforce_paymethod=qr
    ```
    ```python
    import requests
  ...
  <Accordion title="Sample request with multiple categories" icon="fa-code">
    ...
    **Credit Card, Net Banking, and Wallet (`creditcard|netbanking|cashcard`)**
    ...
    # Parameters include key, txnid, amount, surl, furl, hash; enforce_paymethod=creditcard|netbanking|cashcard
    ```
    ```python
    import requests
