...
.glass-btn {
    position: relative;
    background: linear-gradient(135deg, rgba(255,255,255,0.3), rgba(255,255,255,0.1)); /* More opacity for better contrast */
...
.glass-btn:hover {
    ...
    background: linear-gradient(135deg, rgba(255,255,255,0.4), rgba(255,255,255,0.2)); /* Lighter on hover */
}
