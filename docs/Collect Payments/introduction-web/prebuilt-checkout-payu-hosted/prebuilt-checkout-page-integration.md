...
<Cards columns={1}>
  <Card title="Automatically Generate Code for your PayU Hosted Checkout Integration" href="https://payu.in/integrationlab/payu-hosted" icon="fa-code" target="_blank">
