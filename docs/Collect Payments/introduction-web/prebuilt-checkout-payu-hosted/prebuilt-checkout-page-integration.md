...
<Callout icon="❗️">
  **Important UPI Integration Changes as per RBI Mandate on UPI Collect Disablement**: If you are using PayU Hosted Checkout within a WebView inside your Android or iOS app, you must handle deeplink URL handling in your app. For implementation details, refer to [WebView for Mobile Apps](doc:webview-for-mobile-apps).
</Callout>
