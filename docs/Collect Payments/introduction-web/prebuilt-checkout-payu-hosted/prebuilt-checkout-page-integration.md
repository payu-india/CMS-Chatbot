...
<Cards columns={3}>
  <Card title="1. Start Integration" href="#step-1--start-integration" target="_blank">
...
<Accordion title="Step 1.4: Use Sample request" icon="fa-times-circle">
...
<Accordion title="Step 1.5: Response handling & hash verification" icon="fa-shield-check">
  ...
  **Step 1.5.1: Response verification using reverse hashing**
