...
<Cards columns={1}>
  <Card title="Auto-generate code to integrate PayU Hosted Checkout" href="https://payu.in/integrationlab/payu-hosted" icon="fa-code" target="_blank">
    Autommatically generate code for your eCommerce website to integrate PayU Hosted Checkout with zero coding knowledge. Click this card.
  </Card>
</Cards>
...
<button onclick="alert(href="https://payu.in/integrationlab/payu-hosted" icon="fa-code" target="_blank")" 
        class="tooltip-btn" 
        data-tooltip="Autommatically generate code including hashing for your eCommerce website to integrate PayU Hosted Checkout with zero coding knowledge.">
    Auto-generate code to integrate PayU Hosted Checkout
</button>
`}</HTMLBlock>
