...
<Accordion title="How do I test my payment integration?" icon="fa-info-circle">
...
<Accordion title="Where can I get the test Key/Salt details?" icon="fa-info-circle">
...
<Accordion title="What is the role of Key/Salt in the encryption process?" icon="fa-info-circle">
...
<Accordion title="What happens if I lose my Key/Salt?" icon="fa-info-circle">
...
<Accordion title="How do I get my Key/Salt?" icon="fa-info-circle">
...
<Accordion title="Can I share my Key/Salt with others?" icon="fa-info-circle">
...
<Accordion title="What is Cross-Origin Resource Sharing (CORS)?" icon="fa-info-circle">
...
<Accordion title="How can I handle CORS errors?" icon="fa-info-circle">
...
<Accordion title="Can I use my Production Key and Salt details on API Reference?" icon="fa-info-circle">
...
<Accordion title="What should I do if my request parameters are not working?" icon="fa-info-circle">
...
<Accordion title="I am receiving a “bad request” error message when posting my API request. What could be causing this?" icon="fa-info-circle">
...
<Accordion title="I am not receiving any response when posting my API request. What could be causing this?" icon="fa-info-circle">
...
<Accordion title="I am receiving an “invalid parameter” error message when posting my API request. What does this mean?" icon="fa-info-circle">
...
<Accordion title="The response from PayU is not in JSON format and it is in an encrypted format. How do I get the response in JSON format?" icon="fa-info-circle">
...
<Accordion title="When I posted an API with all the necessary values to PayU, I got a response similar to the following, and not sure why?" icon="fa-info-circle">
...
<Accordion title="What is a webhook?" icon="fa-info-circle">
...
<Accordion title="How do I test my webhooks?" icon="fa-info-circle">
  You can test your webhooks by using the Test Webhook feature available in your PayU Dashboard.
</Accordion>

<Accordion title="How do I create a webhook?" icon="fa-info-circle">
...
<Accordion title="Can I create webhooks manually?" icon="fa-info-circle">
...
<Accordion title="What is the fee or TDR for using PayU’s payment gateway?" icon="fa-info-circle">
