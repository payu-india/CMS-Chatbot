...
<Tabs>
  <Tab title="Request Parameters">
    **Mandatory Parameters**
    ...
    | bankcode    | `String` Each payment option is identified with a unique bank code at PayU. For the list of bank codes, refer to [Card Type Codes and Supported Banks for Cards](doc:card-type-codes-and-supported-banks-for-cards) |
