...
<Tabs>
  <Tab title="Request Parameters">
    **Mandatory Parameters**
    ...
    | s2s_device_info                   | `String` Device information/user-agent string of the client. For more information, refer to [Accepted values for s2s_device_info](#accepted-valiues-for-s2s_device_info)                                                                                                                                                                                                                      |   Dalvik/2.1.0 (Linux; U; Android 13; Pixel 7 Build/...)        |
    ...
    **Optional Parameters**
    ...
    #### Accepted values for s2s\\_device\\_info
