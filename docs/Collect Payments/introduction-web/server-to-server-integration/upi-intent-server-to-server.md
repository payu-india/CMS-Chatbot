...
<Accordion title="Step 2: Get Intent URI" icon="fa-code">
  ...
  <Accordion title="Request Parameters" icon="fa-table">
    ...
    |upiAppName `mandatory`|Any of the values listed under the [upiAppName list](upiAppName-list)|amazonpay|
    ...
    | s2s\_device\_info `conditional`                                                       | `String` Customer agent's device information. For the list of accepted values, refer to [s2s_device_info Values Description](#s2s_device_info-values-description) table<br/> **Note**: This Required for UPI Intent flow.                                                                                                                                                                                             |  |
    ...
    | buyer\_type\_business `optional in case of B2B transaction for cross-border payments` | `Binary` To be sent as "1" in case the buyer is a business. In case of individual buyers, it can be skipped. Default is "0". <br/>**Note**: This will be included in hash if posted (covered in next section                                                                 | 1                                           |
