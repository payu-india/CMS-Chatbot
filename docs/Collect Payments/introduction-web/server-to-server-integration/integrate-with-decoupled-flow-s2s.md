...
<Accordion title="Request parameters" icon="fa-code">
  <HTMLBlock>{`
             ...
             <tr>
               ...
               <td style="border: 1px solid #ddd; padding: 8px;"><p><code>String</code>This parameter must be passed with the value as **1 **for this parameter.</p>
             </td>
             ...
             <tr>
               ...
               <td style="border: 1px solid #ddd; padding: 8px;">REDIRECT</td>
             </tr>
             <tr>
