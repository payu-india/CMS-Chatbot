...
| UPI                  | UPI    | N/A                      | UPI payments require the customer to enter their UPI ID or scan a QR code. The pg value depends on whether its collect or intent flow. If its UPI collect, the customer will need to manually authorize the payment from the UPI app and no bankcode is required for UPI. For more information on integration, refer to [Net Banking Integration](doc:collect-payments-with-net-banking-seamless)                                                                                                                                          |
...
| QR Code              | UPI    | N/A                      | The QR code format should be as per Bharat QR specifications. For more information on integration, refer to [Payment Initiation API – Integrated Bharat QR](ref:payment-initiation-api-integrated-bharat-qr).                                                                                                                                                                                                                                                                                                                              |
