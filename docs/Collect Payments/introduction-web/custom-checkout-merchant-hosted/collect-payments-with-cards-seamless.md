...
<Tabs>
  <Tab title="Request Parameters">
    ...
    | :------------------------------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :--------------------------------------------------------------------------------------------- | - |
    | <Glossary>key</Glossary> `mandatory`         | `String` Merchant key provided by PayU during onboarding.                                                                                                                                                                                                                      | JP\*\*\*g                                                                                      |   |
    | <Glossary>txnid</Glossary> `mandatory`       | `String` The transaction ID is a reference number for a specific order generated by the merchant. Must be unique.                                                                                                                                                              | ypl938459435                                                                                   |   |
    | amount `mandatory`                           | `String` The payment amount for the transaction.                                                                                                                                                                                                                               | 10.00                                                                                          |   |
    | <Glossary>productinfo</Glossary> `mandatory` | `String` A brief description of the product.                                                                                                                                                                                                                                   | iPhone                                                                                         |   |
    ...
    | <Glossary>pg</Glossary> `mandatory`          | `String` Defines the payment category. For cards, use **CC**.                                                                                                                                                                                                                  | CC                                                                                             |   |
    | <Glossary>bankcode</Glossary> `mandatory`    | `String` Each payment option has a unique <Glossary>bankcode</Glossary> at PayU. Refer to [Card Type Codes and Supported Banks](https://docs.payu.in/docs/card-type-codes-and-supported-banks-for-cards).                                                                      | AMEX                                                                                           |   |
    | ccnum `mandatory`                            | `String` Use 13–19 digit card number for credit/debit cards (15 digits for AMEX, 13–19 for Maestro). Validate with LUHN algorithm.                                                                                                                                             | 5123456789012346                                                                               |   |
    | ccname `mandatory`                           | `String` Name on card as entered by the customer for the transaction.                                                                                                                                                                                                          | Ashish Kumar                                                                                   |   |
    | ccvv `mandatory`                             | `String` Use 3-digit <Glossary>CVV</Glossary> for credit/debit cards and 4-digit security code (4DBC/CID) for AMEX cards. Validate with BIN API.                                                                                                                               | 123                                                                                            |   |
    | ccexpmon `mandatory`                         | `String` Card's expiry month in MM format (2 digits). Prepend 0 for months 1–9.                                                                                                                                                                                                | 10                                                                                             |   |
    | ccexpyr `mandatory`                          | `String` Card's expiry year in 4 digits.                                                                                                                                                                                                                                       | 2021                                                                                           |   |
    | <Glossary>furl</Glossary> `mandatory`        | `String` The failure URL which PayU will redirect to if the transaction fails.                                                                                                                                                                                                 | [https://apiplayground-response.herokuapp.com/](https://apiplayground-response.herokuapp.com/) |   |
    | <Glossary>surl</Glossary> `mandatory`        | `String` The success URL which PayU will redirect to if the transaction is successful.                                                                                                                                                                                         | [https://apiplayground-response.herokuapp.com/](https://apiplayground-response.herokuapp.com/) |   |
    | <Glossary>hash</Glossary> `mandatory`        | `String` The <Glossary>hash</Glossary> calculated by the merchant using the <Glossary>key</Glossary> and <Glossary>Salt</Glossary>. Hash calculation logic: <Glossary>SHA-512</Glossary>(key\|txnid\|amount\|productinfo\|firstname\|email\|udf1\|udf2\|udf3\|udf4\|udf5\|\|\| | \|\|<Glossary>Salt</Glossary>)                                                                 | ) |

    ### Optional Parameters

    | Parameter                                                 | Description                                                                                                                                                                    | Example         |
    | :-------------------------------------------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :-------------- |
    | address1 `optional`                                       | `String` The first line of the billing address. _For&#x20;_<Glossary>Fraud Detection</Glossary>: This information is helpful for fraud detection and chargebacks.              | 123 Main Street |
    ...
    | zipcode `optional`                                        | `String` Billing address zip code. Mandatory for the cardless <Glossary>EMI</Glossary> option. Character Limit: 20.                                                            | 400001          |
    | <Glossary>User Defined Field</Glossary> (udf1) `optional` | `String` <Glossary>User Defined Field</Glossary> used to store any information corresponding to a particular transaction. You can use up to five udfs designated as udf1–udf5. | custom_value_1  |
    | <Glossary>User Defined Field</Glossary> (udf2) `optional` | `String` <Glossary>User Defined Field</Glossary> used to store any information corresponding to a particular transaction. You can use up to five udfs designated as udf1–udf5. | custom_value_2  |
    | <Glossary>User Defined Field</Glossary> (udf3) `optional` | `String` <Glossary>User Defined Field</Glossary> used to store any information corresponding to a particular transaction. You can use up to five udfs designated as udf1–udf5. | custom_value_3  |
    | <Glossary>User Defined Field</Glossary> (udf4) `optional` | `String` <Glossary>User Defined Field</Glossary> used to store any information corresponding to a particular transaction. You can use up to five udfs designated as udf1–udf5. | custom_value_4  |
    | <Glossary>User Defined Field</Glossary> (udf5) `optional` | `String` <Glossary>User Defined Field</Glossary> used to store any information corresponding to a particular transaction. You can use up to five udfs designated as udf1–udf5. | custom_value_5  |
  ...
  <Tab title="Sample Request">
    ...
    ```
    ```javascript
    // ⚠️ IMPORTANT: Run this SERVER-SIDE ONLY (Node.js).
    // Never expose card details (ccnum, ccvv, ccexpmon, ccexpyr) in browser/client-side
    // JavaScript — this violates PCI DSS compliance standards.

    const url = "https://test.payu.in/_payment";

    const params = new URLSearchParams();
    params.append("key", "YOUR_MERCHANT_KEY");
    params.append("txnid", "TXN_12345");
    params.append("amount", "1000.00");
    params.append("productinfo", "Product Description");
    params.append("firstname", "Customer Name");
    params.append("email", "customer@example.com");
    params.append("phone", "9988776655");
    params.append("pg", "CC");
    params.append("bankcode", "CC");
    params.append("ccnum", "CARD_NUMBER");
    params.append("ccexpmon", "MM");
    params.append("ccexpyr", "YY");
    params.append("ccvv", "CVV");
    params.append("ccname", "NAME_ON_CARD");
    params.append("surl", "https://yourwebsite.com/success");
    params.append("furl", "https://yourwebsite.com/failure");
    params.append("hash", "HASH_GENERATED_ON_SERVER");
    ...
    async function initiateCardPayment() {
        try {
            ...
            console.error("Error initiating card payment:", error.message);
        }
    }
