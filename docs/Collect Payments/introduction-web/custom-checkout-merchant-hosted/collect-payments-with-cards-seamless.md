...
<Accordion title="Step 2: Initiate the payment to PayU" icon="fa-code">
  ...
  <Accordion title="Request Parameters" icon="fa-code">
    ...
    **Environment**
    ...
    <Callout icon="📘" theme="info">
      **Reference**: For the **Try It** experience and response, refer to <Anchor label="Collect Payment API - Merchant Hosted Checkout" target="_blank" href="ref:_payment_merchant_hosted">Collect Payment API - Merchant Hosted Checkout</Anchor> under API Reference.
    </Callout>
...
<Accordion title="Handling Guest Checkout Transactions" icon="fa-code">
  ...
  <Image align="center" src="https://files.readme.io/f84108124634526cf547dac1d59ff3272600f8cfd26f486baba8425033ddf5c8-Guest-checkout-alt-id-implementation-methods.png" width="900px" />
