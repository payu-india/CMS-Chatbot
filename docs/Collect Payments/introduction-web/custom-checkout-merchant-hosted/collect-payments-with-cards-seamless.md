...
<Accordion title="Request Parameters" icon="fa-table">
  ...
  **Environment**
  ...
  <Callout icon="📘" theme="info">
    **Reference**: For the **Try It** experience and response, refer to <Anchor label="Collect Payment API - Merchant Hosted Checkout" target="_blank" href="https://docs.payu.in/reference/payment_merchant_hosted">Collect Payment API - Merchant Hosted Checkout</Anchor> under API Reference.
  </Callout>
...
<Accordion title="Scenario 3: Provision Alt ID from PayU" icon="fa-code">
  The Provision Alt ID API is used to provision Alt ID from PayU, but process transaction outside PayU. For more information, refer to [Provision Alt ID API](target="_blank" href="https://docs.payu.in/reference/provision-alt-id-api).
</Accordion>
