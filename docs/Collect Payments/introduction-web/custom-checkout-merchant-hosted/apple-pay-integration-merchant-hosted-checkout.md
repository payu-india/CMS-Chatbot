...
This page describes how to integrate Apple Pay as a payment method using PayU's Merchant Hosted Checkout.
...
| email<br/>`mandatory` | `String` - This parameter contains the email address of the customer. | john@example.com |
...
| surl<br/>`mandatory` | `String` - This parameter contains the Success URL. PayU will redirect the customer to this URL after a successful payment. | https://yoursite.com/success |
| furl<br/>`mandatory` | `String` - This parameter contains the Failure URL. PayU will redirect the customer to this URL after a failed payment. | https://yoursite.com/failure |
