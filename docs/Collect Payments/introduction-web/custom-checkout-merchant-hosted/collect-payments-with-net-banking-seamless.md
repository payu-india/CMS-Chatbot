...
<Accordion title="Post request syntax & composition" icon="fa-code">
  ...
  */
  ...
  <Callout icon="📘" theme="info">
	**Note:** 
	The above codes are for testing the Merchant Hosted Checkout integration with net banking as a payment method. You can use this [net banking credential](https://docs.payu.in/docs/test-cards-upi-id-and-wallets#test-net-banking-credentials) to test the integration.
  </Callout>
</Accordion>
