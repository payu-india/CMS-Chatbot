...
<table>
  ...
  <tbody>
    <tr>
      <td colspan="3" style="text-align: center; font-weight: bold; background-color: #f5f5f5;">Environment URLs</td>
    </tr>
    <tr>
      <td><strong>Test Environment</strong></td>
      <td><code>String</code> URL for test environment</td>
      <td><a href="https://test.payu.in/_payment">https://test.payu.in/_payment</a></td>
    </tr>
    <tr>
      <td><strong>Production Environment</strong></td>
      <td><code>String</code> URL for production environment</td>
      <td><a href="https://secure.payu.in/_payment">https://secure.payu.in/_payment</a></td>
    </tr>
    <tr>
      <td colspan="3" style="text-align: center; font-weight: bold; background-color: #f5f5f5;">Request Parameters</td>
    </tr>
    <tr>
