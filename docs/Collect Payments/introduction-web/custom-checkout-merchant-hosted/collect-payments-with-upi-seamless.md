...
<Cards columns={2}>
  <Card title="1. Validate the UPI handle" href="https://docs.payu.in/docs/collect-payments-with-upi-seamless#step-1-valiadate-the-upi-handle" target="_blank">
    Validate the card type using the Validae VPA API
  </Card>

  <Card title="2. Initiate the Payment to PayU" href="https://docs.payu.in/docs/collect-payments-with-upi-seamless#step-2-initiate-the-payment-to-payu" target="_blank">
...
<Callout icon="⚠️" theme="warning">
  **Important UPI Integration Changes as per RBI Mandate on UPI Collect**:
