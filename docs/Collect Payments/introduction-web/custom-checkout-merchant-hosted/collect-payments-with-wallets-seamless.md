...
<Accordion title="Request parameters" icon="fa-table">
  ...
  **Environment**
  ...
  | pg `mandatory`          | String - It defines the payment category using the Merchant Hosted Checkout integration. Use the following values accordingly: <br/> - Generally for all wallets: `CASH`</br>- For Advantage Club: `RD`                                                                                        | CASH and for RD for Advantage Club  |
