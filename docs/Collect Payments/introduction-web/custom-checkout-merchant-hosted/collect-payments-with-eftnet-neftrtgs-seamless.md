...
<Cards columns={3}>
  <Card title="1. Initiate the Payment to PayU" href="https://docs.payu.in/docs/collect-payments-with-eftnet-neftrtgs-seamless#step-1-initiate-the-payment-to-payu">
