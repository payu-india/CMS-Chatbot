...
<Callout icon="📘" theme="info">
  ...
  - Salt is a suspectible information. **Do not** pass Salt in the payment request. 
...
<Callout icon="🚧" theme="warn">
  ...
  Salt is a suspectible information. **Do not** pass Salt in the payment request. To know more about generating salt, see [Generate Merchant Key and Salt on PayU Dashboard](doc:generate-merchant-key-and-salt-copy#).
</Callout>
...
<Accordion title="Tips for Hashing" icon="fa-lightbulb">
...
<Callout icon="📘" theme="info">
  ...
  - For most command-based postservice APIs, PayU uses `sha512(key|command|var1|salt)`. Regenerate the hash whenever request parameters change. See [Request and Response Format](doc:rest-api-format) and [API Authentication and Security](doc:api-authentication-and-security).
</Callout>

| API                                                                                             | command                                                | Hash logic                                                                                |
| ----------------------------------------------------------------------------------------------- | ------------------------------------------------------ | ----------------------------------------------------------------------------------------- |
| [Verify Payment API](ref:verify_payment_api)                                                    | verify\_payment                                        | `sha512(key\|command\|var1\|salt)`                                                        |
...
| [Get TDR API](ref:get_tdr_api)                                                                  | get\_TDR                                               | `sha512(key\|command\|var1\|salt)`                                                        |
| [Refund Transaction API](ref:refund_transaction_api)                                            | cancel \_refund<br />\_transaction                     | Calculated using the sha512 algorithm with the format: `sha512(key\|command\|var1\|salt)` |
...
| [Check Action Status with PayU ID](ref:check_action_status_api_with_payu_id)                    | check \_action<br />\_status                           | `sha512(key\|command\|var1\|salt)`                                                        |
| [Check Refund Status with Request ID API](ref:check_action_status_api_with_request_id)          | check _action <br />_&#x73;tatus\_txnid                | `sha512(key\|command\|var1\|salt)`                                                        |
...
| [Get EMI Amount according to Interest API](ref:get_emi_according_to_interest_api)               | getEmiAmount<br />According<br />ToInterest            | `sha512(key\|command\|var1\|salt)`                                                        |
...
| [UDF Update API](ref:udf_update_api)                                                            | udf\_update                                            | `hash = sha512(key\|command\|var1\|salt)`                                                 |
| [Recurring Payment Transaction API](ref:recurring_payment_api)                                  | si\_transaction                                        | `sha512(key\|command\|var1\|salt)` sha512                                                 |
...
| [Split After Transaction API](ref:split_after_transaction_api)                                  | payment\_split                                         | `sha512(key\|command\|var1\|salt)`                                                        |
| [Refund Status API for Split Payments](ref:refund-status-api-for-split-payments)                | aggregator<br /> \_check\_action<br /> \_status\_txnid | `sha512(key\|command\|var1\|salt)`                                                        |
| [Cancel Omnichannel Transaction API](ref:cancel-omnichannel-transaction-api-1)                  | cancel \_omni<br />\_payment                           | `sha512(key\|command\|var1\|salt)`                                                        |
