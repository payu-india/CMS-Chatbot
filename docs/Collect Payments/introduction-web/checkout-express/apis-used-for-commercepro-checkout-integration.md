...
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- |
| Enable CommercePro — [CommercePro Checkout](https://docs.payu.in/docs/checkout-express) **(Integration)**                                                                        | NA                                       | Enables CommercePro Checkout so you can use its address, offer, recommendation, and payment capabilities.                  |
