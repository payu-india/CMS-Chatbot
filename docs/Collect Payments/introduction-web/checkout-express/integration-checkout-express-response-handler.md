...
<Cards columns={2}>
  ...
  <Card title="3. Fetch the response using response handler" href="https://docs.payu.in/?isFramePreview=true#step-3-fetch-the-response-using-response-handler" target="_blank">
