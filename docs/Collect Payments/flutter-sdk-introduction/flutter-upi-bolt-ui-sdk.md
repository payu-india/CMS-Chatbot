...
<Accordion title="Clear SDK Cache of PayUBolt SDK" icon="folder" id="clear-sdk-cache">
  ...
  **Response**: [SDK Response JSON Format:](#https://docs.payu.in/docs/flutter-upi-bolt-ui-sdk#sdk-response-json-format)
...
<Accordion title="Step 2. Check if UPI Bolt is Enabled" icon="folder" id="step-2-check-enabled">
  ...
  **Response:** `Map` [SDK Response JSON Format:](#)
...
[Refer to SDK Response JSON Format](#flutter-upi-bolt-ui-sdk#sdk-response-json-format#sdk-response-json-format)
