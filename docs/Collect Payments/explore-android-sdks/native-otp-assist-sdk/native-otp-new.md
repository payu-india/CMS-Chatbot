...
<Accordion title="5.2: onPaymentSuccess - Handle Successful Payment" icon="fa-code">
  ...
  public void onPaymentSuccess(@Nullable String merchantResponse, 
      ...
      // payUResponse: Response from PayU gateway
      
      Log.d("PayU", "Payment Success");
      Log.d("PayU", "Merchant Response: " + merchantResponse);
      Log.d("PayU", "PayU Response: " + payUResponse);
...
<Accordion title="5.3: onPaymentFailure - Handle Failed Payment" icon="fa-code">
  ...
  public void onPaymentFailure(@Nullable String merchantResponse, 
      ...
      Log.e("PayU", "Merchant Response: " + merchantResponse);
      Log.e("PayU", "PayU Response: " + payUResponse);
      ...
      try {
          ...
          Toast.makeText(context, "Payment Failed: " + errorMessage, 
  ...
  override fun onPaymentFailure(merchantResponse: String?, 
      ...
      try {
          ...
          val errorMessage = response.optString("Error_Message")
          val errorCode = response.optString("error_code")
...
<Accordion title="5.4: onError - Handle SDK Errors" icon="fa-code">
  ...
  public void onError(@Nullable String errorCode, 
                      @Nullable String errorMessage) {
      // Handle errors
      Log.e("PayU", "Error Code: " + errorCode);
      Log.e("PayU", "Error Message: " + errorMessage);
