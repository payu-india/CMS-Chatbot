...
<Table align={[null,null,"left"]}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        `String`When the transaction is successful, PayU will send webhook response in this URL and pass the transaction response.
      </td>
    ...
    <tr>
      ...
      <td>
        `String` When the transaction is failed,  PayU will send webhook response in this URL and pass the transaction response.
      </td>
...
| `generateHash`          | Called to generate payment hash. Merchant will get a map with the type of hash and hash string as the value of the map.  https://docs.payu.in/docs/hash-generation-for-checkoutpro-sdk |
