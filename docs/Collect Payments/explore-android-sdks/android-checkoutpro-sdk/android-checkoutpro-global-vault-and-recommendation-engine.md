...
Global Vault and Recommendation engine is live with PayU Checkout Pro SDK which needs V2 hash. For more information on hashing, refer to [Generate Dynamic Hash](doc:hash-generation-for-checkoutpro-sdk).
