...
Use the latest version of the Checkout Pro SDK and add/update the config on the PayU Dashboard. The changes will automatically reflect in your app. To enable this configuration, refer to [Dynamic Configuration using Dashboard](doc:dynamic-configuration-using-dashboard-copy).
