...
metadata:
  ...
  description: >-
    Learn how to integrate PayU’s Flutter SDK into your app, and choose the
    right SDK for your needs. Get started with our developer guide today.
  keywords:
    - PayU Mobile SDK
    - ' Payment Gateway for Flutter Mobile'
    - ' PayU India Flutter SDK'
    - PayU Flutter SDK
    - ' PayU Flutter SDK integration'
    - ' Flutter payment SDK'
    - ' Mobile payment Flutter SDK'
  robots: index
next:
  description: ''
---
