...
| `tavv` optional | `String` Transaction authorization verification value                                                                                                                                                                                                                                                                       |    |
| `tokenRefNo`    | `String` Reference number for tokenized card                                                                                                                                                                                                                                                                                |    |
| `trid`          | `String` Transaction ID for this payment                                                                                                                                                                                                                                                                                    |    |
