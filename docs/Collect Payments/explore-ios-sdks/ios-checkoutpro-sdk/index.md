...
metadata:
  title: iOS Checkout Pro SDK
  description: >-
    The CheckoutPro SDK offers a Mobile Checkout solution for iOS Apps with easy
    integration to PayU PG and support for various payment options. Compatible
    with iOS 11 and includes customization capabilities.
  keywords:
    - IOS Checkout Pro SDK
    - PayU IOS SDK integration
    - Mobile payment integration with PayU IOS SDK
    - PayU IOS Checkout Pro setup for Mobile
    - IOS CheckoutPro SDK
