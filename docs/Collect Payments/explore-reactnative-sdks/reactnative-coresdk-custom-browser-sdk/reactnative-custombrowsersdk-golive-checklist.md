...
After [testing the integration](https://docs.payu.in/docs/reactnative-custombrowsersdk-test-integration) end-to-end, once you are confident that the integration is working as expected, you can switch to live mode to start accepting payments from your customers. 
...
Set the value of the `environment`to `1` in the payment integration code. This enables the integration to accept live payments.
