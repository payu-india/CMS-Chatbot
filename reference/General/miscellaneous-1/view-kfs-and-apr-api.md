...
| Parameter | Description | Example |
|-----------|-------------|---------|
| status<br/><code>mandatory</code> | `Number` Response status code. `1` indicates success, `0` indicates failure. | `1` |
| message<br/><code>mandatory</code> | `String` Response message describing the result of the API call. | `"Success"` |
| data<br/><code>optional</code> | `Object` Container for the response data when the request is successful. | See data object parameters below |

### data Object Parameters

| Parameter | Description | Example |
|-----------|-------------|---------|
| requestId<br/><code>mandatory</code> | `String` Echoes the request identifier from the input for tracking purposes. | `"Test212345"` |
| kfs_url<br/><code>optional</code> | `String` URL to download or view the Key Fact Statement document for the specified lender and amount. | `"https://api.payu.in/documents/kfs/HDFCD03_26462_KFS.pdf"` |
| apr_details<br/><code>optional</code> | `Object` Annual Percentage Rate details and related fee information. | See apr_details parameters below |
| lender_details<br/><code>optional</code> | `Object` Information about the lender for which KFS and APR data is provided. | See lender_details parameters below |

### apr_details Object Parameters

| Parameter | Description | Example |
|-----------|-------------|---------|
| annual_percentage_rate<br/><code>optional</code> | `String` The calculated Annual Percentage Rate including all fees and charges. | `"12.5%"` |
| processing_fee<br/><code>optional</code> | `String` Processing fee percentage charged by the lender. | `"2%"` |
| interest_rate<br/><code>optional</code> | `String` Base interest rate charged by the lender before additional fees. | `"11.5%"` |

### lender_details Object Parameters

| Parameter | Description | Example |
|-----------|-------------|---------|
| lender_name<br/><code>optional</code> | `String` Full name of the lending institution. | `"HDFC Bank"` |
| lender_code<br/><code>optional</code> | `String` Echoes the ibibo_code from the request to confirm the lender. | `"HDFCD03"` |
