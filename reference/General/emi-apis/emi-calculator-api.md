...
| additional\_charges<br /><code>optional</code>      | This parameter must include the convenience fee if the merchant wants to collect.                                          |
...
| result               | The result is in JSON format with an array of EMI options. For example, EMI6, EMI12, EMI18, etc. For more information, refer to <a href="#emi-json-fields-description">EMI JSON fields description</a>. | 10000.0  |
...
| sku                  | SKU details in a JSON format. For more information, refer to <a href="#sku-json-fields-description">sku JSON fields description</a>.                                                                    | Product1 |
...
| bankCode             | Bank code of the bank providing EMI. For more information, refer to <a href="doc:emi-codes">EMI Codes</a>.                                                                                              | YESB     |
| emi\_value           | EMI value calculated.                                                                                                                                                                                   | 555.55   |
| emi\_interest\_paid  | Total interest paid over the EMI tenure.                                                                                                                                                                | 1266.78  |
