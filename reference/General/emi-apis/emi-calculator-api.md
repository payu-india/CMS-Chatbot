...
| result               | The result is in JSON format with an array of EMI options. For example, EMI6, EMI12, EMI18, etc. For more information, refer to <a href="https://docs.payu.in/reference/emi-calculator-ap#emi-json-fields-description">EMI JSON fields description</a>. | 10000.0  |
...
| sku                  | SKU details in a JSON format. For more information, refer to <a href="https://docs.payu.in/reference/emi-calculator-ap#sku-json-fields-description">sku JSON fields description</a>.                                                                    | Product1 |
