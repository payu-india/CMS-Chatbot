---
title: '[OLD]Get All Refunds from Transaction IDs'
excerpt: 'API Command: **getAllRefundsFromTxnIds**'
api:
  file: get-all-refunds-for-txnid-2.json
  operationId: GetAllRefundsfromTransactionIDs
deprecated: false
hidden: true
metadata:
  title: Get All Refunds from Transaction IDs
  description: >-
