...
- For the response details in the **transaction_details** parameter, refer to [Additional Info for General APIs](ref:addl-info-general-apis#json-field-description-for-transaction_details-parameter). 
