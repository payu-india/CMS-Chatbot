...
|                        |                                                               |
| :--------------------- | :------------------------------------------------------------ |
| Test Environment       | https://info.payu.in/settlement/v1/merchantUpcomingSettlement |
...
| result.upcomingSettlements                             | Array   | Array of upcoming settlement schedules                        |
| result.upcomingSettlements[].expectedSettlementDate    | String  | Expected date for settlement (YYYY-MM-DD)                     |
| result.upcomingSettlements[].expectedAmount            | String  | Expected gross settlement amount                              |
| result.upcomingSettlements[].transactionCount          | Integer | Number of transactions to be settled                          |
| result.upcomingSettlements[].settlementCycle           | String  | Settlement cycle (T+1, T+2, etc.)                             |
| result.upcomingSettlements[].transactionDateRange      | Object  | Date range of transactions included                           |
| result.upcomingSettlements[].transactionDateRange.from | String  | Start date of transaction range (YYYY-MM-DD)                  |
| result.upcomingSettlements[].transactionDateRange.to   | String  | End date of transaction range (YYYY-MM-DD)                    |
| result.upcomingSettlements[].estimatedFees             | String  | Estimated processing fees to be deducted                      |
| result.upcomingSettlements[].estimatedTax              | String  | Estimated tax on fees                                         |
| result.upcomingSettlements[].netExpectedAmount         | String  | Expected net amount after fees and tax                        |
| result.pendingSettlements                              | Array   | Array of delayed/pending settlements                          |
| result.pendingSettlements[].originalSettlementDate     | String  | Originally scheduled settlement date                          |
| result.pendingSettlements[].transactionDate            | String  | Date of transactions that are pending settlement              |
| result.pendingSettlements[].pendingAmount              | String  | Gross amount pending settlement                               |
| result.pendingSettlements[].reason                     | String  | Human-readable reason for delay                               |
| result.pendingSettlements[].reasonCode                 | String  | System code for delay reason (BANK_HOLIDAY, TECH_ISSUE, etc.) |
| result.pendingSettlements[].expectedClearanceDate      | String  | Expected date when settlement will be processed               |
| result.pendingSettlements[].transactionCount           | Integer | Number of transactions pending settlement                     |
| result.pendingSettlements[].estimatedFees              | String  | Estimated fees for pending transactions                       |
| result.pendingSettlements[].estimatedTax               | String  | Estimated tax on fees for pending transactions                |
| result.pendingSettlements[].netPendingAmount           | String  | Expected net amount for pending settlement                    |
| result.summary                                         | Object  | Overall summary of upcoming and pending settlements           |
| result.summary.totalUpcomingAmount                     | String  | Total gross amount in upcoming settlements                    |
| result.summary.totalPendingAmount                      | String  | Total gross amount in pending settlements                     |
| result.summary.totalExpectedNet                        | String  | Total expected net amount after all deductions                |
| result.summary.nextSettlementDate                      | String  | Date of the next scheduled settlement                         |
...
| pendingSettlements[].reasonCode                 | String  | System code for delay reason (BANK_HOLIDAY, TECH_ISSUE, etc.) |
