...
| card_no        | This parameter would contain the masked card number using which customer has made the transaction on QR for CARD transactions. Please ignore this parameter for UPI transactions on QR                                                                                                                                                                                                                                |
...
| bank_ref_num   | For each successful & failed transaction, this parameter would contain the bank reference number generated by the bank                                                                                                                                                                                                                                                                                                |
