...
[block:parameters]
{
  "data": {
    ...
    "11-1": "`string` Pass cash back amount only for SALE WITH CASH BACK transaction type otherwise pass null value.",
    "11-2": "null",
    "12-0": "deviceCommMode   \n `Optional`",
...
[block:parameters]
{
  "data": {
    ...
    "0-2": "Refer to <<ICCTransactionRespons>> payload objects."
  },
  "cols": 3,
  "rows": 1,
  "align": [
