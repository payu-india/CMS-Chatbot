...
excerpt: ''
api:
  file: partner-integration-updated-4.json
  operationId: CreatePaymentLinkAPI
deprecated: false
hidden: false
metadata:
  title: Create Payment Link API for Partner Integration
  description: >-
  ...
  keywords:
    - Create Payment Link for Partner Integration
    - ' Create Link for Customer'
    - ' Partner Payment Link API'
  robots: index
next:
  description: ''
---
