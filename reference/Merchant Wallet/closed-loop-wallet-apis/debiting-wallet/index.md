...
metadata:
  ...
  robots: index
---
This part of the API reference includes the following APIs to debit the amount using seamless or non-seamless integration from wallet and check the debit status:
