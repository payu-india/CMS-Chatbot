...
<Table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        `String`If no value is passed in Beneficiary ID, any of the folloinw value needs to be passed in activation status.  There are three types of status:  
    ...
    <tr>
      ...
      <td>
        `String`If value is passed,  all beneficiary details of that specific wallet need to be provided in API response.\
        Conditional - with urn, customer id and mobile\
        `Character Limit - 15`
      </td>
    ...
    <tr>
      ...
      <td>
        `String`Denotes whether transaction is fund transfer or wallet closure\
        `Character Limit - 100`
      </td>
