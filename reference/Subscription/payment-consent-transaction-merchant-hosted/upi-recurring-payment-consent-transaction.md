...
[block:parameters]
{
  "data": {
    ...
    "18-2": "UPI",
    "19-0": "bankcode  \n`mandatory`",
    "19-1": "varchar This parameter contains UPI or INTENT for UPI.",
    "19-2": "UPI",
    "20-0": "si  \n`mandatory`",
    ...
    "23-1": "`integer` This parameter must be passed with the values as 4 for UPI Intent.",
    "23-2": "4"
  },
  "cols": 3,
  "rows": 24,
