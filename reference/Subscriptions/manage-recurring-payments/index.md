...
excerpt: >-
  Manage recurring payments with PayU across Cards, Net Banking, and UPI. Check
  the status and modify or cancel a mandate.
deprecated: false
hidden: true
metadata:
  description: >-
    Manage recurring payments with PayU across Cards, Net Banking, and UPI.
    Check the status and modify or cancel a mandate.
  robots: index
---
