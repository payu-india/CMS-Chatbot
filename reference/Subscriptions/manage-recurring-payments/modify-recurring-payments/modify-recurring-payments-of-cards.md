...
<Table align={["left","left"]}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        `json` The SI mandatory details that need to be passed during registration transaction from your system to PayU. Parameters are described in the [si\_details Object](https://docs.payu.in/reference/modify-recurring-payments-of-cards#si_details-json-parameters) section.
      </td>
    </tr>
