---
title: Modify Recurring Payments
excerpt: >-
  Modify recurring payments and mandates for Cards, UPI, NetBanking, and other
  supported payment methods using PayU APIs. Update recurring payment details,
  billing rules, and mandate configurations securely.
deprecated: false
hidden: true
metadata:
  robots: index
