...
| **command**<sup style={{color: 'red'}}>*</sup> | `varchar` The command API follows. Possible values: <ul><li>**For Cards:** <code>check_mandate_status</code></li> <li>**For NetBanking (NB):** <code>NB_mandate_status</code></li> <li>**For UPI:** <code>upi_mandate_status</code></li></ul> |
