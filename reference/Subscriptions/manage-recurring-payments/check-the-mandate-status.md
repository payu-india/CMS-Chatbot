...
>
> Parameters marked with e following payment methods:
>
> &#x20;are mandatory.

| **Parameter**                                  | **Description**                                                                                                                                                                                                                                     |
| :--------------------------------------------- | :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **key**<sup style={{color: 'red'}}>*</sup>     | `varchar` The unique Merchant Key provided by PayU for your account.                                                                                                                                                                                |
| **command**<sup style={{color: 'red'}}>*</sup> | `varchar` The command API follows. Possible values: <ul><li>**For Cards:** <code>check\_mandate\_status</code></li> <li>**For NetBanking (NB):** <code>NB\_mandate\_status</code></li> <li>**For UPI:** <code>upi\_mandate\_status</code></li></ul> |
...
| **hash**<sup style={{color: 'red'}}>*</sup>    | `varchar` 512 SHA hash strings generated by encrypting request parameters so that any tampering can be avoided. The value is calculated using the following logic: `hash = sha512(key\|command\|var1\|SALT)`                                        |
