...
| store_card_token<br />`conditional`     | `varchar` This must include the Network token generated at your end.<br />This parameter is required if you are using the stored card token to register the mandate.<br/> **Note:** For RuPay cards only the following flows are supported: <ul><li>PayU Token Flow</li> <li>Tokenised Transaction Flow (Merchant initiated transaction with network token)</li></ul>                                                                                                                                                                                                                                                | 1234 4567 2456 3566                                                                                                                |
