...
metadata:
  robots: index
---
This part of the document includes the following BIN APIs used to check the customer eligibility based on their merchant ID or in combination with the card BIN:
