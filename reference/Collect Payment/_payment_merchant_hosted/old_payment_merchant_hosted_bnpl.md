...
metadata:
  ...
  description: ''
  keywords:
    - BNPL Merchant Hosted Checkout Collect Payment API
    - Simulator for PayU payment collection
    - BNPL Custom Checkout integration with PayU
    - Collect payments using PayU API
    - Collect Payment API for BNPL Merchant Hosted Checkout
    - _payment API for BNPL Merchant Hosted Checkout
    - _payment API simulation for BNPL Custom Checkout
    - _payment API simulation for BNPL Merchant Hosted Checkout
  robots: index
next:
  description: ''
  pages:
    - type: basic
      slug: collect-payments-with-bnpl
