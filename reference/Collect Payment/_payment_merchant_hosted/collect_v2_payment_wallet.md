...
[block:parameters]
{
  "data": {
    ...
    "1-0": "vpa  \n`mandatory for UPI`",
    "1-1": "`String`UPI handle of the customer. ",
    "2-0": "forcePgid  \n `optional`",
    "2-1": "`String`Force identification for payment gateway integration.",
    "3-0": "partnerHoldTime  \n `optional`",
    "3-1": "`String`Time held by partner for the transaction.",
    "4-0": "userCredentials  \n `optional`",
    "4-1": "`String`Credentials for user authentication during payment."
  },
  "cols": 2,
  "rows": 5,
  "align": [
