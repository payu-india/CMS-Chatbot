...
<Accordion title="Request parameters" icon="fa-table">
  ...
  | additional\_info<br />`mandatory` | `Object` Contains the Account Funding Transaction (AFT) payment details. For more information, refer to [additional\_info JSON parameters description](#additional_info-json-parameters-description).                                                                                                                              | Refer to [additional\_info JSON parameters description](#additional_info-json-parameters-description) |        |             |           |       |      |      |      |      |      |   |   |   |   |   |         |   |
