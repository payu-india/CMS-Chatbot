...
| additional_info<br/>`mandatory` | `Object` Contains the Account Funding Transaction (AFT) payment details. For more information, refer to [additional_info JSON parameters description](#additional_info-json-parameters-description). | Refer to [additional_info JSON parameters description](#additional_info-json-parameters-description) |
