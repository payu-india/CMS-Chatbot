...
<tr>
  <td style="border: 1px solid #ddd; padding: 8px;"><p>authorization<br><code>mandatory for S2S Direct Auth</code></p>
</td>
  <td style="border: 1px solid #ddd; padding: 8px;"><p><code>Object</code>3DS authorization information.  For more information, refer to refer to<a href="#authorization-object-field-descriptions"> authorization object field descriptions</a>   .</p>
</td>
  <td style="border: 1px solid #ddd; padding: 8px;"></td>
</tr>
<tr>
  <td style="border: 1px solid #ddd; padding: 8px;"><p>threeDS2RequestData<br><code>mandatory for S2S</code></p>
</td>
  <td style="border: 1px solid #ddd; padding: 8px;"><p><code>Object</code> 3DS authorization information.  For more information, refer to refer to<a href="#threeds2requestdata-object-field-descriptions">threeDS2RequestData object field description</a>   .</p>
</td>
  <td style="border: 1px solid #ddd; padding: 8px;"></td>
</tr>
</tbody>
...
<tr>
  ...
  <td style="border: 1px solid #ddd; padding: 8px;"><p><code>String</code> This field must contain the payment mode code. For more information, refer to <a href="https://docs.payu.in/v1/reference/payment-mode-codes">Payment Mode Codes</a>. For cards, this must contain any of the following:  </p>
<ul>
<li><strong>creditcard</strong> for credit card</li>
<li><strong>debitcard</strong> for debit card</li>
</ul>
</td>
</tr>
<tr>
...
<tbody>
<tr>
  <td style="border: 1px solid #ddd; padding: 8px;"><p>eci<br><code>mandatory</code></p>
</td>
  <td style="border: 1px solid #ddd; padding: 8px;"><p><code>String</code>The electronic commerce indicator is used in payer authentication to indicate the level of security used when the cardholder provided payment information to the merchant. Its value corresponds to the authentication result and the characteristics of the merchant checkout process.</p>
</td>
  <td style="border: 1px solid #ddd; padding: 8px;"><p>05</p>
</td>
</tr>
<tr>
  <td style="border: 1px solid #ddd; padding: 8px;"><p>cavv<br><code>mandatory</code></p>
</td>
  <td style="border: 1px solid #ddd; padding: 8px;"><p><code>String</code>The Cardholder Authentication Verification Value (CAVV) is specified here.</p>
</td>
  <td style="border: 1px solid #ddd; padding: 8px;"><p>AAABAWFlmQAAAABjRWWZEEFgFz</p>
</td>
</tr>
<tr>
  <td style="border: 1px solid #ddd; padding: 8px;"><p>flowType<br><code>mandatory</code></p>
</td>
  <td style="border: 1px solid #ddd; padding: 8px;"><p><code>String</code>This field must contain any of the following flow types:  </p>
<ul>
<li>Frictionless</li>
<li>Challenge.</li>
</ul>
</td>
  <td style="border: 1px solid #ddd; padding: 8px;"><p>Frictionless</p>
</td>
</tr>
<tr>
  <td style="border: 1px solid #ddd; padding: 8px;"><p>threeDSTransID<br><code>mandatory</code></p>
</td>
  <td style="border: 1px solid #ddd; padding: 8px;"><p><code>String</code>This field must contain the 3DS transaction ID.</p>
</td>
  <td style="border: 1px solid #ddd; padding: 8px;"><p>67b4c71f-19bf-4d97-bd09-4e3687dc9e42</p>
</td>
</tr>
<tr>
  <td style="border: 1px solid #ddd; padding: 8px;"><p>threeDSServerTransID<br><code>mandatory</code></p>
</td>
  <td style="border: 1px solid #ddd; padding: 8px;"><p><code>String</code>This field must contain the 3DS server transaction ID.</p>
</td>
  <td style="border: 1px solid #ddd; padding: 8px;"><p>eea30d14-71cf-41af-b961-f95b7d67dc93</p>
</td>
</tr>
<tr>
  <td style="border: 1px solid #ddd; padding: 8px;"><p>threeDSTransStatus<br><code>mandatory</code></p>
</td>
  <td style="border: 1px solid #ddd; padding: 8px;"><p><code>String</code>This field must contain the 3DS transaction status. It can be any of the following: Y, N, U or R.</p>
</td>
  <td style="border: 1px solid #ddd; padding: 8px;"><p>Y</p>
</td>
</tr>
<tr>
  <td style="border: 1px solid #ddd; padding: 8px;"><p>threeDSTransStatusReason<br><code>mandatory</code></p>
</td>
  <td style="border: 1px solid #ddd; padding: 8px;"><p>This field must contain the 3DS transaction reason. It can be an integer in the range 0-99.</p>
</td>
  <td style="border: 1px solid #ddd; padding: 8px;"><p>01</p>
</td>
</tr>
<tr>
  <td style="border: 1px solid #ddd; padding: 8px;"><p>acquirer_bin<br><code>mandatory</code></p>
</td>
  <td style="border: 1px solid #ddd; padding: 8px;"><p><code>String</code> This field must contain the Bank Identification Number (BIN) that is used to clear and settle the transaction within Visa and the country in which it is licensed for use.</p>
</td>
  <td style="border: 1px solid #ddd; padding: 8px;"><p>401200</p>
</td>
</tr>
<tr>
  <td style="border: 1px solid #ddd; padding: 8px;"><p>additionalInfo<br><code>mandatory</code></p>
</td>
  <td style="border: 1px solid #ddd; padding: 8px;"><p><code>Object</code> This contains the following fields to include the additional authentication information:  </p>
<ul>
<li>authudf1</li>
<li>authudf2</li>
</ul>
</td>
  <td style="border: 1px solid #ddd; padding: 8px;"><p>1_1665637507_954_104<br>_l73c004m_IAMRB</p>
</td>
</tr>
</tbody>
</table>
...
<tbody>
<tr>
  <td style="border: 1px solid #ddd; padding: 8px;"><p>threeDSVersion<br><code>mandatory</code></p>
</td>
  <td style="border: 1px solid #ddd; padding: 8px;"><p><code>String</code>The message protocol version is to be specified in this field.</p>
</td>
  <td style="border: 1px solid #ddd; padding: 8px;"><p>2.2.0</p>
</td>
</tr>
<tr>
  <td style="border: 1px solid #ddd; padding: 8px;"><p>deviceChannel<br><code>mandatory</code></p>
</td>
  <td style="border: 1px solid #ddd; padding: 8px;"><p><code>String</code>The channel of transaction is to be specified in this field.</p>
</td>
  <td style="border: 1px solid #ddd; padding: 8px;"><p>APP</p>
</td>
</tr>
</tbody>
</table>
