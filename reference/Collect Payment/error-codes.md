...
<SearchableTable
  ...
  rows={[
    ...
    ['EX032', 'Cancel Error: Mandatory column missing. Mandatory columns are:  ? ', 'CANCEL_ERROR_MANDATORY_COLUMN', 'Cancel Error: Mandatory column missing. Mandatory columns are:  ? '],
    ['EX033', 'Refund Error: Invalid File or no data ?', 'REFUND_ERROR_INVALID_FILE', 'Refund Error: Invalid File or no data ?'],
    ['EX034', 'Refund Error: Mandatory column missing. Mandatory columns are:  ? ', 'REFUND_ERROR_MANDATORY_COLUMN', 'Refund Error: Mandatory column missing. Mandatory columns are:  ? '],
    ['EX035', 'Capture Error: Invalid File or no data', 'CAPTURE_ERROR_INVALID_FILE', 'Capture Error: Invalid File or no data'],
    ['EX036', 'Captured Error: Mandatory column missing. Mandatory columns are:  ? ', 'CAPTURE_ERROR_MANDATORY_COLUMN', 'Captured Error: Mandatory column missing. Mandatory columns are:  ? '],
    ...
    ['EX038', 'Reconciliation Error: Mandatory column missing. Mandatory columns are:  ? ', 'RECONCILIATION_ERROR_MANDATORY_COLUMN', 'Reconciliation Error: Mandatory column missing. Mandatory columns are:  ? '],
    ...
    ['EX087', 'Transaction failed due to incorrectly calculated hash parameter. ?', 'CHECKSUM_FAILED', 'Transaction failed due to incorrectly calculated hash parameter. ?'],
    ...
    ['EX096', 'Reconciliation Error: Undefined actions requested. Defined actions are :  ?  Change  ?  action(s) to appropriate actions.', 'RECONCILIATION_ERROR_UNDEFINED_ACTION', 'Reconciliation Error: Undefined actions requested. Defined actions are :  ?  Change  ?  action(s) to appropriate actions.'],
    ...
    ['EX104', 'Reporting Error: Mandatory column missing. Mandatory columns are:  ? ', 'REPORTING_ERROR_MANDATORY_COL_MISSING', 'Reporting Error: Mandatory column missing. Mandatory columns are:  ? '],
    ['EX105', 'Upload Error: Mandatory column missing. Mandatory columns are:  ? ', 'UPLOAD_ERROR_MANDATORY_COL_MISSING', 'Upload Error: Mandatory column missing. Mandatory columns are:  ? '],
    ...
    ['EX107', 'Refund Reference Number Upload Error: Mandatory column missing. Mandatory columns are:  ? ', 'REFUND_UPLOAD_ERROR_MANDATORY_COL_MISS', 'Refund Reference Number Upload Error: Mandatory column missing. Mandatory columns are:  ? '],
    ['EX108', 'This txnid has been used previously or was successfully captured. ?', 'DUPLICATE_ORDER_ID', 'This txnid has been used previously or was successfully captured. ?'],
    ...
    ['EX115', 'The key ? value which you are using in the transaction request - is currently inactive. ?', 'PAYMENTFLOW_INACTIVE_MERCHANT', 'The key ? value which you are using in the transaction request - is currently inactive. ?'],
    ...
    ['EX130', 'Error: Mandatory column missing. Mandatory columns are:  ? ', 'ERROR_MANDATORY_FILE_MISSING', 'Error: Mandatory column missing. Mandatory columns are:  ? '],
    ...
    ['EX147', 'You seem to be using an incorrect key or salt value. ?', 'INCORRECT_MERCHANT_KEY', 'You seem to be using an incorrect key or salt value. ?'],
    ['EX148', 'Invalid Request: ? Unable to parse URL.', 'INVALID_URL', 'Invalid Request: ? Unable to parse URL.'],
    ['EX149', 'Maximum retry attempts for this txnid has been exceeded.', 'RETRY_EXHAUSTED', 'Maximum retry attempts for this txnid has been exceeded.'],
