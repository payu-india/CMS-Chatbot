...
<Callout icon="📘" theme="info">
  **Note**: This documentation covers the **non-seamless (hosted checkout)** integration. For seamless payment flows, refer to the <Anchor label="v2 Payment API (Seamless)" target="_blank" href="doc:v2-payment-api-seamless">v2 Payment API (Seamless)</Anchor> documentation.
</Callout>
