...
excerpt: >-
  ...
  **Purpose:** Upload KYC documents for merchant verification including document
  ...
  uploading KYC documents | `8390925` |
  ...
  Get Token API with the scope 'refer merchant' to obtain the token  | `Bearer
  ec1b0d6e5e9890950ddfc902c1c18aadc4053653995712300b6a644f82c56d02` |
