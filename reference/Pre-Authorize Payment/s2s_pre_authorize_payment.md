...
next:
  description: ''
---
The **pre_authorize** parameter is used to pre-authorize payments using the S2S integration along with the parameters to collect card details and S2S parameters.
