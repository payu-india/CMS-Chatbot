...
metadata:
  ...
  robots: index
---
This section describes the request and response parameters with sample request and response for UPI Reserve Pay OTM Intent with PayU Hosted Checkout integration (non-seamless flow). For more information on Reserve Pay, 
