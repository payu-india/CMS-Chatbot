...
metadata:
  title: UPI Reserve Pay One-Time Mandate - PayU Hosted
  keywords:
    - UPI Reserve Pay One-Time Mandate - PayU Hosted
    - PayU Hosted Reserve Pay
    - Reserve Pay PayU Hosted
  robots: index
---
This section describes the request and response parameters with sample request and response for UPI Reserve Pay OTM Intent with PayU Hosted Checkout integration (non-seamless flow). For more information on Reserve Pay integration, refer to [UPI Reserve Pay](doc:upi-reserve-pay).
...
<Table align={["left","left","left"]}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        This parameter contains the following information in JSON format:  _paymentStartDate_ paymentEndDate \* multiCapture\\
      </td>
...
Once the transaction is authorised by the customer, PayU will receive confirmation. PayU will pass confirmation to the merchant as webhook
