...
| email `mandatory` | `String` Customer email address. | pragram@gmail.com |
...
| surl `mandatory` | `String` Success URL. PayU redirects here after a successful payment. | https://payu.in/integrationlab/callback.php |
| furl `mandatory` | `String` Failure URL. PayU redirects here after a failed payment. | https://payu.in/integrationlab/callback.php |
