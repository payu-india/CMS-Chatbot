...
* [Release Settlement API](ref:release_settlement_api) : It is used to release the settlement of all the blocked child transactions in the aggregator workflow.For more information, refer to Release Payment API.
