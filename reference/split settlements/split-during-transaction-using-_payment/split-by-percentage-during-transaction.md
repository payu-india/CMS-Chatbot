---
title: Split by Percentage During Transaction
excerpt: ''
deprecated: false
hidden: false
metadata:
...
[block:parameters]
{
  "data": {
    ...
    "h-2": "**Example**",
    "0-0": "type  \n**mandatory**",
    "0-1": "`string` Specify the **percentage** type of split in this field. The percentage of the amount is specified for each part of the split. The percentage of the amount is specified in the **aggregatorSubAmt** field of the JSON for each child or aggregator.",
    "0-2": "percentage",
    "1-0": "splitInfo  \n**mandatory**",
    ...
    "1-2": "Refer the [JSON request structure of splitInfo](#json-request-structure-of-splitinfo) subsection."
  },
  "cols": 3,
  "rows": 2,
  "align": [
