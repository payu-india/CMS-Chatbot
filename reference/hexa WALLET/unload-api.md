...
<Table align={["left","left","left"]}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        `String` Refer to [IMPL Mapping List](ref:impl-mapping-list) for the Impl ID and descriptions.
      </td>
    ...
    <tr>
      ...
      <td>
        `String` Refer to [IMPL Mapping List](ref:impl-mapping-list) for the IMPL type and descriptions.
      </td>
