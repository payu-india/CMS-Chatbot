...
<Table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        `String` Customer Id (entityCIF), which uniquely identifies the cardholder in the client system. Conditional with mobile number and URN i.e either one of them should be present.\
        `Character Limit - 20`
      </td>
    ...
    <tr>
      ...
      <td>
        `String` Encrypted card Number of the card holder. `Character Limit - 10`
      </td>
...
<Table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        Document Type Of the CardHolder. One Card Holder can have many Documents.
      </td>
