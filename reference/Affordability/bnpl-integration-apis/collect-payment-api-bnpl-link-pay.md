...
<Table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        This parameter describes the payment category by which the transaction was completed or attempted by the customer. For the payment categories, refer to [Payment Mode Codes](https://devguide.payu.in/merchant-integration/bank-and-card-codes-for-integration/payment-mode-codes/).
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        This is the value of the payu token which is mapped against a payment instrument
      </td>
    </tr>
  </tbody>
</Table>
