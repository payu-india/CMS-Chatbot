...
<Table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        SHA512 Signature generated by encrypting request parameters in the body by Merchant Key, Merchant Salt and Plan ID. For more information on how to create this signature, refer to [X-PayU-Subscription Signature generation guidelines.](#x-payu-subscription-signature-generation-guidelines)
      </td>
    </tr>
  </tbody>
</Table>
...
* INVOICE\_DUE\_HTTP – When ***invoiceId*** is generated and request is registered by Zion
* INVOICE\_PAID\_HTTP – When generated ***invoiceId*** is paid successfully
* INVOICE\_FAILED\_HTTP – When generated ***invoiceId*** is failed after 3 retry attempts till next 3 days
