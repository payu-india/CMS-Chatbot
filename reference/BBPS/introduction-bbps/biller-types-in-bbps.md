...
| -------- | --------- | ------------------ | --------------------- | ------------------------- | -------------------- | ------------------------------------ | --------------------------------------------------------------------------------------------------------------------- |
| 1        | ONLINE    | T                  | OPTIONAL              |                           |                      | • Yes                                | • Ad-hoc Payment canbe done (for any amount).                                                                         |
...
|          |           |                    | OPTIONAL              |                           |                      | • No                                 | • Payment against fetch can also be done for any amount.                                                              |
| 8        | OFFLINE A | T                  | NOT\_SUPPORTED        | OPTIONAL                  | Yes (T/F)            | • Yes                                | • Ad-hoc Payment canbe done (for any amount).                                                                         |
|          |           |                    | NOT\_SUPPORTED        | OPTIONAL                  | Yes (T/F)            | • No                                 | • Payment against validation can also be done for any amount.                                                         |
...
| 15       | OFFUNE B  | T                  | NOT\_SUPPORTED        | NOT\_SUPPORTED            | Yes (T/F)            | • Yes                                | • Ad-hoc Payment canbe done (for any amount).                                                                         |