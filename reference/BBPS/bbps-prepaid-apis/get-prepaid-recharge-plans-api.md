---
title: Get Prepaid Recharge Plans API
excerpt: ''
api:
  file: bbps-apis-agent-share-3.json
  operationId: GetPrepaidRechargePlans
deprecated: false
hidden: false
metadata:
  title: ''
...
[block:parameters]
{
  "data": {
    ...
    "6-0": "message",
    "6-1": "This field contains the message type as **mobile_fetch_request_failed** for this API.",
