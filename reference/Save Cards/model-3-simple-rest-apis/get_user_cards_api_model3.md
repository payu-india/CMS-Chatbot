...
<Accordion title="Response parameters" icon="fa-list">
  ...
  | user\_cards | A JSON object containing all saved cards for the user. Each card is identified by its unique card token as the key. | Refer to Card Object Parameters below |
  ...
  | network\_token          | A JSON object containing network token details for secure payments.                                                   | Refer to Network Token Parameters below |
