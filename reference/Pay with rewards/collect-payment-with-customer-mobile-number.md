...
[block:parameters]
{
  "data": {
    ...
    "10-2": "",
    "11-0": "pg  \n**mandatory**",
    "11-1": "`String` The pg parameter must contain the payment category using the Merchant Hosted Checkout integration. For Pay with Rewards, \"**CASH**\" must be specified in the pg parameter.  \n   - EFTNET (NEFT/RTGS): **NEFTRTGS**",
    "11-2": "",
    "12-0": "bankcode  \n**mandatory**",
    "12-1": "`String`Pass the bankcode as **TWID** for Flipkart Supercoins redemption.",
    "12-2": "",
    "13-0": "surl  \n**mandatory**",
