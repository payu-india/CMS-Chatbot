---
title: Collect Payment with Customer Mobile Number
excerpt: ''
deprecated: false
hidden: true
metadata:
...
next:
  description: ''
---
The payment with rewards can be done with customer mobile for the first to get the customer hash, so the subsequent transactions can be done using the customer hash. This section describes the request and response parameters for payment with customer hash.
...
<Table align={["left","left","left"]}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        `String`This parameter must contain the URL on which PayU\
