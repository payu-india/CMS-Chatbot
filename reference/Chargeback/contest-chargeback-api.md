...
<Table align={["left","left","left"]}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
       Dependent on response received from the Read Reasons API, the Value(evidence) to be submitted for contesting the chargeback, for a particular reason code(UUID), should be text(plain text), image(png ,jpeg/jpg) or file(doc,docx,pdf)." Currently, this is not encoded.. For more information, refer to [Read Reasons API](ref:read-reasons-api).
      </td>
