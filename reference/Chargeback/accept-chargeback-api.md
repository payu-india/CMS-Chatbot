...
| status  | This field contains the status of the chargeback. For the list of various chargeback states, refer to [Chargeback Status List](https://docs.payu.in/docs/chargeback-status) . | Pending Doc Review |
    ...
    "data": [
        ...
        },
        {
            ...
            "attributes": {
                ...
                "form-data": [
                    {
                        "identifier": "5b73bfd8-5048-4af6-a934-71624b723edd",
                        "form-data-text": "product out of stock",
        ...
        },
        {
            ...
            "attributes": {
                ...
                "form-data": [
                    {
                        "identifier": "0eeb9d01-f705-4cb4-96ea-9255d501ddba",
                        "form-data-text": "paid",
        ...
        },
        {
            ...
            "attributes": {
                ...
                "form-data": [
                    {
                        "identifier": "ada4b023-4822-4226-ae6d-1f22295e2d79",
                        "form-data-text": "Successful",
                        "field-type": "amount_tag",
                        "options": [],
                        "blank-allowed": false,
                        "mandatory": false
        ...
        },
        {
            ...
            "attributes": {
                ...
                "form-data": [
                    {
                        "identifier": "ef73f2a7-40f9-4529-8b61-d4678a68c2a2",
                        "form-data-text": "S Yamini",
                        "field-type": "amount_tag",
                        "options": [],
                        "blank-allowed": false,
                        "mandatory": false
        ...
        },
        {
            ...
            "type": "reasons",
            "attributes": {
                "identifier": "adc084a5-214d-4bd9-84f9-49630fe72296",
                "parent-id": null,
                "reason-text": "Generic  reject reason",
                "field-type": "radio-button",
                "reason-type": "reject",
                "message": false,
                "form-data": [
                    {
                        "identifier": "c577e546-4277-41c1-99a2-0681e86b9bea",
                        "form-data-text": "generic reject",
                        "field-type": "file_tag",
                        "options": [],
                        "blank-allowed": false,
                        "mandatory": true
