...
<Callout icon="📘" theme="info">
  **Note**: The **Regenerate Token** API is used to regenerate only. Use the Chargeback Dashboard to easily generate token for the first time. For more information, refer to [Generate Token on Chargeback Dashboard](ref:get_token_chargeback_dashboard)
</Callout>
