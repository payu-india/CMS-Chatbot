...
<Callout icon="👍" theme="okay">
  Experience the end-to-end **Merchant Hosted Checkout** flow and instantly generate the complete code for seamless, zero-coding integration into your website. Select **First-Time Customer > Payment API (_payment)** or **Repeat Customer > Payment API (_payment)** from left navigation pane after opening the following page based on the use case:
