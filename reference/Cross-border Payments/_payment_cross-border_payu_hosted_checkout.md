...
<Callout icon="👍" theme="okay">
  Experience the end-to-end **Cross-Border Payments** flow and instantly generate the complete code for seamless, zero-coding integration into your website.
...
<Accordion title="Additional information for request parameters" icon="fa-book">
  ...
  * **buyer\_type\_business**: This parameter is specific to Cross Border payments and indicates the type of business of the buyer (e.g., "Travels", "Education", "Software", etc.)
</Accordion>
