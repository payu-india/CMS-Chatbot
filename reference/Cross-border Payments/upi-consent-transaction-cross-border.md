...
| email<br />`mandatory`               | `String`<br />The email address of the customer. Character Limit: 50                                                                                                                                                                                     | test@payu.in                                |
...
| E001       | Invalid Hash                         |
| E002       | Invalid Key                          |
| E003       | Missing Mandatory Parameters         |
| E004       | Invalid VPA                          |
| E005       | VPA not eligible for recurring       |
...
<Callout icon="📘" theme="info">
  ...
  * Before making a payment request, validate the UPI handle using the **validateVPA API** to ensure it is eligible for recurring payments.
  * For UPI mandate/recurring transactions, `udf4` should NOT be passed.
  * The `si_details` JSON string must be included in the hash calculation.
  * For UPI Intent, extract the `intentURIData` and launch the UPI app to complete the mandate registration.
  * Configure webhooks to receive real-time transaction status updates.
</Callout>
