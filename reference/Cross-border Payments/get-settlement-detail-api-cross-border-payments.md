...
| :-------------------- | :------------------------------------------------------------------------------------------------------------------------------------------------------------- | :--------- |
| settledOn `mandatory` | This parameter must contain either date for the settlement or UTR (Unique Transaction Reference number).                                                       | 2023-09-26 |
...
| time\_zone            | This parameter contains the time zone in which the transaction was performed.                                                                                                                                                              | UTC + 05:30            |
...
| action                | This parameter contains the action taken on the transaction. For description of the various unmapped status, refer to [List of Unmapped Status](#list-of-unmapped-status)                                                                  | capture                |
...
| transfer\_currency    | This parameter contains the currency to which conversion was done.                                                                                                                                                                         | INR                    |
| transaction\_currency | This parameter contains the currency with which transaction was performed.                                                                                                                                                                 | USD                    |
| forexRate             | This parameter contains the foreign exchange rate for currency in the **transactionCurrency** to **transactionCurrency** parameter.                                                                                                        | 80.45                  |
| finalSettlement       | This parameter contains the final settlement done to merchant.                                                                                                                                                                             | 20000.45               |
