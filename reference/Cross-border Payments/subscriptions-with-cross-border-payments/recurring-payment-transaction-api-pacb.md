...
| udf4<br />`conditional`                            | `String` - **PA2PA Integration**: Merchant Name or Seller Name.<br /><br />⚠️ **Important**: For UPI mandate consent and recurring transactions, **this field should NOT be passed**.                                                                                                                                                                                                        | **PA2PA**: `MerchantABC or Ashsih`<br /><br />**UPI Mandate/Recurring**: Do not pass                                         |
| udf5<br />`mandatory`                              | `String` - Invoice ID for every merchant . **This field is mandatory during or after the transaction** (using the `udf_update` API post successful transaction).  <br /><br />⚠️ **Important**: For UPI mandate consent and recurring transactions, **this field should NOT be passed**.                                                                                                     | INV789012                                                                                                                    |
