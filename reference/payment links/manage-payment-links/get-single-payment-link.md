...
> 📘 Note:
>
> The access token with the scope as **read_payment_links** is required on the header. For more information on getting the access token, refer to [Get Access Token](ref:get-token-api-for-payment-links).
...
<tr>
  ...
  <td style="border: 1px solid #ddd; padding: 8px;"><p>Bearer <code>String</code> This contains the client_token. For getting a token, refer to <a href="https://docs.payu.in/reference/get-token-api-for-payment-links">Get Access Token</a> .</p>
</td>
</tr>
</tbody>
</table>
