...
<details>
  ...
  <HTMLBlock>{`
        ...
        <tr>
          ...
          <td style="border: 1px solid #ddd; padding: 8px;"><p>Displays the error code in case of any error in this field. For the list of error codes, refer to <a href="https://docs.payu.in/reference/error-codes-for-payouts">Error Codes</a>.</p>
        </td>
        </tr>
        <tr>
