...
metadata:
  ...
  keywords:
    ...
    - ' Payouts Initiate Transfer API'
    - ' Transfer Initiation API'
    - ' Payouts Initiation API'
  robots: index
next:
  description: ''
---
The **Initiate Payment** API is used to initiate/schedule a single transfer to the beneficiary account, UPI address, or credit card.
