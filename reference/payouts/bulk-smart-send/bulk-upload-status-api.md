...
|                            |                                                                                                                                                    |
| -------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Test Environment**       | [https://staging.payu.in/payout/v2/bulkUpload/transfers/`\{fileId}`](https://staging.payu.in/payout/v2/bulkUpload/transfers/`\{fileId}`)           |
| **Production Environment** | [https://payout.payumoney.com/payout/v2/bulkUpload/transfers/`\{fileId}`](https://payout.payumoney.com/payout/v2/bulkUpload/transfers/`\{fileId}`) |
