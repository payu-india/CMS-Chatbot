...
<tr>
  ...
  <td style="border: 1px solid #ddd; padding: 8px;"><p><code>String</code>This parameter will contain the public Client ID which is identical for and used by all Payouts Merchants. For getting your client_id , refer to <a href="https://docs.payu.in/docs/get-client-id-and-secret-from-dashboard">Get Client ID and Secret from Dashboard</a>.</p>
</td>
