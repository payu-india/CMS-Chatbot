...
|                            |                                                                                                                                                      |
| -------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Test Environment**       | [https://uatoneapi.payu.in/payout/v2/smartSend/expiry/`\{smartSendId}`](https://uatoneapi.payu.in/payout/v2/smartSend/expiry/`\{smartSendId}`)       |
| **Production Environment** | [https://payout.payumoney.com/payout/v2/smartSend/expiry/`\{smartSendId}`](https://payout.payumoney.com/payout/v2/smartSend/expiry/`\{smartSendId}`) |
