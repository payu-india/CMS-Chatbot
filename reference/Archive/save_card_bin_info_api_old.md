---
title: '[OLD]Save Card BIN API'
excerpt: 'API Command: **issuing-bank/v1/bin**'
api:
  file: general-apis-16.json
  operationId: SaveCardBINInfo
deprecated: false
hidden: true
metadata:
  title: ''
...
<Table>
  ...
  <tbody>
    <tr>
      ...
      <td>
        This parameter returns the status of card. The status can be any of the following:
      </td>
    ...
    <tr>
      ...
      <td>
        This field contains the card category of the card.
      </td>
    ...
    <tr>
      ...
      <td>
        `Integer` This field contains the first 9-digits of the card or Network Token.
      </td>
    ...
    <tr>
      ...
      <td>
        This field contains any of the following values:  
    ...
    <tr>
      ...
      <td>
        `Boolean` This field contains any of the following values:  
    ...
    <tr>
      ...
      <td>
        This field contains the card type or the card network.
      </td>
