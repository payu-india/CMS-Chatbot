...
| Field          | Description                                                                                                                                      | Example                                                                                                                                                            |
| :------------- | :----------------------------------------------------------------------------------------------------------------------------------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| txnId          | This field contains the unique transaction ID sent by merchant in request.                                                                       | TXN0001                                                                                                                                                            |
| referenceId    | This field contains the unique ID generated by PayU.                                                                                             | 7000000001                                                                                                                                                         |
| txnStatus      | This field contains the the status of the transaction.                                                                                           | failed, pending                                                                                                                                                    |
| unmappedStatus | This field returns the status of the transaction at different stages of transaction. For more information, refer to the Unmapped Status section. | pending, failure                                                                                                                                                   |
| statusCode     | This field returns the internal status codes of PayU.                                                                                            | E342                                                                                                                                                               |
| message        | This field returns the failure message if the transaction is failed.                                                                             | Transaction not initiated                                                                                                                                          |
| qrString       | This field use to generate QR code                                                                                                               | upi://pay?pa=gauravdua4.payu@indus&pn=Test<br/> Company&tr=999993715527842445&tid=PPPL<br/>9999937155278424452312250<br/>048356&am=10.00&cu=INR&tn=UPI Transaction |
